...
import YearlyRapportInfoEnvoiFrench from './pages/YearlyRapportInfoEnvoiFrench';
import YearlyRapportInfoEnvoiLingala from './pages/YearlyRapportInfoEnvoiLingala';
import YearlyRapportInfoEnvoiEnglish from './pages/YearlyRapportInfoEnvoiEnglish';
import TableYearlyRapportEnglish from './pages/TableYearlyRapportEnglish';
import TableYearlyRapportFrench from './pages/TableYearlyRapportFrench';
import TableYearlyRapportLingala from './pages/TableYearlyRapportLingala';
import SelectYearFormRetraitFrench from './pages/SelectYearFormRetraitFrench';
import SelectYearFormRetraitLingala from './pages/SelectYearFormRetraitLingala';
import SelectYearFormRetraitEnglish from './pages/SelectYearFormRetraitEnglish';
import YearlyRapportInfoRetraitFrench from './pages/YearlyRapportInfoRetraitFrench';
import YearlyRapportInfoRetraitLingala from './pages/YearlyRapportInfoRetraitLingala';
import YearlyRapportInfoRetraitEnglish from './pages/YearlyRapportInfoRetraitEnglish';
import SelectYearFormRecetteFrench from './pages/SelectYearFormRecetteFrench';
import SelectYearFormRecetteLingala from './pages/SelectYearFormRecetteLingala';
import SelectYearFormRecetteEnglish from './pages/SelectYearFormRecetteEnglish';
import YearlyRecettesEnglish from './pages/YearlyRecettesEnglish';
import YearlyRecettesLingala from './pages/YearlyRecettesLingala';
import YearlyRecettesFrench from './pages/YearlyRecettesFrench';
...
function App() {
  ...
  {
    const localData = localStorage.getItem('message2');
    return localData ? JSON.parse(localData) : "";
  });
  
  
  useEffect(() => {
    window.localStorage.setItem("message2", JSON.stringify(message2))
  }, [message2])

  const [titleEnglish,setTitleEnglish] = useState(()=>
  {
    const localData = localStorage.getItem('titleEnglish');
    return localData ? JSON.parse(localData) : "";
  });
  
  
  useEffect(() => {
    window.localStorage.setItem("titleEnglish", JSON.stringify(titleEnglish))
  }, [titleEnglish])

  const [titleFrench,setTitleFrench] = useState(()=>
  {
    const localData = localStorage.getItem('titleFrench');
    return localData ? JSON.parse(localData) : "";
  });
  
  
  useEffect(() => {
    window.localStorage.setItem("titleFrench", JSON.stringify(titleFrench))
  }, [titleFrench])


  const [titleLingala,setTitleLingala] = useState(()=>
  {
    const localData = localStorage.getItem('titleLingala');
    return localData ? JSON.parse(localData) : "";
  });
  
  
  useEffect(() => {
    window.localStorage.setItem("titleLingala", JSON.stringify(titleLingala))
  }, [titleLingala])
  ...
  {
    const localData = localStorage.getItem('tableType');
    return localData ? JSON.parse(localData) : "";
  });
  
  
  useEffect(() => {
    window.localStorage.setItem("tableType", JSON.stringify(tableType))
  }, [tableType])


  const [rapportType,setRapportType] = useState(()=>
  {
    const localData = localStorage.getItem('rapportType');
    return localData ? JSON.parse(localData) : "";
  });
  
  
  useEffect(() => {
    window.localStorage.setItem("rapportType", JSON.stringify(rapportType))
  }, [rapportType])
  ...
  {
    const localData = localStorage.getItem('modalShow4');
    return localData ? JSON.parse(localData) : false;
  });
...
*/
  ...
  {
    const localData = localStorage.getItem('receiver');
    return localData ? JSON.parse(localData) :[]
  })

  useEffect(() => {
    window.localStorage.setItem("receiver", JSON.stringify(receiver))
  }, [receiver])
  ...
  return ( 
    ...
    <BrowserRouter>
      <Routes >
        ...
        <Route path="/form_envoie_abonne_id_english" element={language2 === "english" ? <FormEnvoiAbonneIdEnglish dataAbonne={dataAbonne} setReceiver={setReceiver} setAbonne={setAbonne} abonne={abonne}  modalShowEnvoi={modalShowEnvoi} setModalShowEnvoi={setModalShowEnvoi}  envoie3={envoie3} isAdmin={isAdmin} isStaff={isStaff} language2={language2} modalShowPasswordChange={modalShowPasswordChange} setModalShowPasswordChange={setModalShowPasswordChange} modalShowContact={modalShowContact} setModalShowContact={setModalShowContact} modalShow={modalShow} modalShow4={modalShow4} setModalShow={setModalShow} setModalShow4={setModalShow4} setLanguage={setLanguage} setLanguage2={setLanguage2} uniqueNumber={uniqueNumber} setUniqueNumber={setUniqueNumber} setUsername={setUsername} setIsadmin={setIsadmin} setIsStaff={setIsStaff} setIsLogged={setIsLogged} isLogged={isLogged} username={username} language={language} /> : language2 === "lingala" ? <Navigate to='/form_envoie_abonne_id' /> : <Navigate to='/form_envoie_abonne_id_french' />} >
        </Route>

        <Route path="/form_envoie_abonne_english" element={abonne.infoAbonne.numero_expediteur == "" ? <Navigate to='/' /> : language2 === "english" ? <FormEnvoiAbonneEnglish  abonne={abonne} setAbonne={setAbonne} receiver={receiver} envoie={envoie} envoie3={envoie3} setEnvoie={setEnvoie} dataEnvoieAbonne={dataEnvoieAbonne} taux={taux} setTaux={setTaux} dataAbonne={dataAbonne} isAdmin={isAdmin} isStaff={isStaff} language2={language2} modalShowPasswordChange={modalShowPasswordChange} setModalShowPasswordChange={setModalShowPasswordChange} modalShowContact={modalShowContact} setModalShowContact={setModalShowContact} modalShow={modalShow} modalShow4={modalShow4} setModalShow={setModalShow} setModalShow4={setModalShow4} setLanguage={setLanguage} setLanguage2={setLanguage2} uniqueNumber={uniqueNumber} setUniqueNumber={setUniqueNumber} setUsername={setUsername} setIsadmin={setIsadmin} setIsStaff={setIsStaff} setIsLogged={setIsLogged} isLogged={isLogged} username={username} language={language}/> : language2 === "lingala" ? <Navigate to='/form_envoie_abonne' /> : <Navigate to='/form_envoie_abonne_french' />} >
        </Route>

        <Route path="/form_retrait_info_english" element={abonne.infoAbonne.numero_expediteur == "" ? <Navigate to='/' /> : language2 === "english" ? <FormRetraitEnglish  dataEnvoie2={dataEnvoie2} envoie3={envoie3} dataAbonne={dataAbonne} abonne={abonne} setAbonne={setAbonne} isAdmin={isAdmin} isStaff={isStaff} language2={language2} modalShowPasswordChange={modalShowPasswordChange} setModalShowPasswordChange={setModalShowPasswordChange} modalShowContact={modalShowContact} setModalShowContact={setModalShowContact} modalShow={modalShow} modalShow4={modalShow4} setModalShow={setModalShow} setModalShow4={setModalShow4} setLanguage={setLanguage} setLanguage2={setLanguage2} uniqueNumber={uniqueNumber} setUniqueNumber={setUniqueNumber} setUsername={setUsername} setIsadmin={setIsadmin} setIsStaff={setIsStaff} setIsLogged={setIsLogged} isLogged={isLogged} username={username} language={language}/>  : language2 === "lingala" ? <Navigate to='/form_retrait_info' /> : <Navigate to='/form_retrait_info_french' />} >
        </Route>
        ...
        <Route path="/envoi_abonne_info_english" element={abonne.infoAbonne.numero_expediteur == "" ? <Navigate to='/' /> : language2 === "english" ?  <EnvoieAbonneInfoEnglish  setForceUpdate={setForceUpdate} setEnvoie3={setEnvoie3}  dataEnvoie3={dataEnvoie3} envoie={envoie} setEnvoie={setEnvoie} envoie3={envoie3} dataAbonne={dataAbonne} isAdmin={isAdmin} isStaff={isStaff} language2={language2} modalShowPasswordChange={modalShowPasswordChange} setModalShowPasswordChange={setModalShowPasswordChange} modalShowContact={modalShowContact} setModalShowContact={setModalShowContact} modalShow={modalShow} modalShow4={modalShow4} setModalShow={setModalShow} setModalShow4={setModalShow4} setLanguage={setLanguage} setLanguage2={setLanguage2} uniqueNumber={uniqueNumber} setUniqueNumber={setUniqueNumber} setUsername={setUsername} setIsadmin={setIsadmin} setIsStaff={setIsStaff} setIsLogged={setIsLogged} isLogged={isLogged} username={username} language={language}/> : language2 === "lingala" ? <Navigate to='/envoi_abonne_info' /> : <Navigate to='/envoi_abonne_info_french' />} >
        </Route>

        <Route path="/confirmation_envoie_info_english" element={abonne.infoAbonne.numero_expediteur == "" ? <Navigate to='/' /> : language2 === "english" ? <ConfirmationEnvoieInfoEnglish clientForm={clientForm} setAbonne={setAbonne} abonne={abonne} setEnvoie3={setEnvoie3} setClientForm={setClientForm} saveAbonne={saveAbonne} setSaveAbonne={setSaveAbonne}  modalShowEnvoi={modalShowEnvoi} setModalShowEnvoi={setModalShowEnvoi} envoie3={envoie3} dataAbonne={dataAbonne} isAdmin={isAdmin} isStaff={isStaff} language2={language2} modalShowPasswordChange={modalShowPasswordChange} setModalShowPasswordChange={setModalShowPasswordChange} modalShowContact={modalShowContact} setModalShowContact={setModalShowContact} modalShow={modalShow} modalShow4={modalShow4} setModalShow={setModalShow} setModalShow4={setModalShow4} setLanguage={setLanguage} setLanguage2={setLanguage2} uniqueNumber={uniqueNumber} setUniqueNumber={setUniqueNumber} setUsername={setUsername} setIsadmin={setIsadmin} setIsStaff={setIsStaff} setIsLogged={setIsLogged} isLogged={isLogged} username={username} language={language}/> : language2 === "lingala" ? <Navigate to='/confirmation_envoie_info' /> : <Navigate to='/confirmation_envoie_info_french' />} >
        </Route>

        <Route path="/retrait_info_english" element={abonne.infoAbonne.numero_expediteur == "" ? <Navigate to='/' /> : language2 === "english" ?  <ConfirmationRetraitInfoEnglish abonne={abonne} envoie2={envoie2} dataAbonne={dataAbonne} envoie3={envoie3} isAdmin={isAdmin} isStaff={isStaff} language2={language2} modalShowPasswordChange={modalShowPasswordChange} setModalShowPasswordChange={setModalShowPasswordChange} modalShowContact={modalShowContact} setModalShowContact={setModalShowContact} modalShow={modalShow} modalShow4={modalShow4} setModalShow={setModalShow} setModalShow4={setModalShow4} setLanguage={setLanguage} setLanguage2={setLanguage2} uniqueNumber={uniqueNumber} setUniqueNumber={setUniqueNumber} setUsername={setUsername} setIsadmin={setIsadmin} setIsStaff={setIsStaff} setIsLogged={setIsLogged} isLogged={isLogged} username={username} language={language}/> : language2 === "lingala" ? <Navigate to='/retrait_info' /> : <Navigate to='/retrait_info_french' />} >
        </Route>
        ...
        <Route path="/form_envoie_abonne_id" element={language2 === "lingala" ? <FormEnvoiAbonneId dataAbonne={dataAbonne} setReceiver={setReceiver} setAbonne={setAbonne} abonne={abonne}  modalShowEnvoi={modalShowEnvoi} setModalShowEnvoi={setModalShowEnvoi}  envoie3={envoie3} isAdmin={isAdmin} isStaff={isStaff} language2={language2} modalShowPasswordChange={modalShowPasswordChange} setModalShowPasswordChange={setModalShowPasswordChange} modalShowContact={modalShowContact} setModalShowContact={setModalShowContact} modalShow={modalShow} modalShow4={modalShow4} setModalShow={setModalShow} setModalShow4={setModalShow4} setLanguage={setLanguage} setLanguage2={setLanguage2} uniqueNumber={uniqueNumber} setUniqueNumber={setUniqueNumber} setUsername={setUsername} setIsadmin={setIsadmin} setIsStaff={setIsStaff} setIsLogged={setIsLogged} isLogged={isLogged} username={username} language={language} /> : language2 === "english" ? <Navigate to='/form_envoie_abonne_id_english' /> : <Navigate to='/form_envoie_abonne_id_french' />} >
        </Route>

        <Route path="/form_envoie_abonne" element={abonne.infoAbonne.numero_expediteur == "" ? <Navigate to='/home_lingala' /> : language2 === "lingala" ? <FormEnvoiAbonne  setAbonne={setAbonne} abonne={abonne} envoie={envoie} receiver={receiver} envoie3={envoie3} setEnvoie={setEnvoie} dataEnvoieAbonne={dataEnvoieAbonne} taux={taux} setTaux={setTaux} dataAbonne={dataAbonne} isAdmin={isAdmin} isStaff={isStaff} language2={language2} modalShowPasswordChange={modalShowPasswordChange} setModalShowPasswordChange={setModalShowPasswordChange} modalShowContact={modalShowContact} setModalShowContact={setModalShowContact} modalShow={modalShow} modalShow4={modalShow4} setModalShow={setModalShow} setModalShow4={setModalShow4} setLanguage={setLanguage} setLanguage2={setLanguage2} uniqueNumber={uniqueNumber} setUniqueNumber={setUniqueNumber} setUsername={setUsername} setIsadmin={setIsadmin} setIsStaff={setIsStaff} setIsLogged={setIsLogged} isLogged={isLogged} username={username} language={language}/> : language2 === "english" ? <Navigate to='/form_envoie_abonne_english' /> : <Navigate to='/form_envoie_abonne_french' />} >
        </Route>

        <Route path="/form_retrait_info" element={abonne.infoAbonne.numero_expediteur == "" ? <Navigate to='/home_lingala' /> : language2 === "lingala" ? <FormRetrait  dataEnvoie2={dataEnvoie2} envoie3={envoie3} abonne={abonne} setAbonne={setAbonne} dataAbonne={dataAbonne} isAdmin={isAdmin} isStaff={isStaff} language2={language2} modalShowPasswordChange={modalShowPasswordChange} setModalShowPasswordChange={setModalShowPasswordChange} modalShowContact={modalShowContact} setModalShowContact={setModalShowContact} modalShow={modalShow} modalShow4={modalShow4} setModalShow={setModalShow} setModalShow4={setModalShow4} setLanguage={setLanguage} setLanguage2={setLanguage2} uniqueNumber={uniqueNumber} setUniqueNumber={setUniqueNumber} setUsername={setUsername} setIsadmin={setIsadmin} setIsStaff={setIsStaff} setIsLogged={setIsLogged} isLogged={isLogged} username={username} language={language}/>  : language2 === "english" ? <Navigate to='/form_retrait_info_english' /> : <Navigate to='/form_retrait_info_french' />} >
        </Route>
        ...
        <Route path="/envoi_abonne_info" element={abonne.infoAbonne.numero_expediteur == "" ? <Navigate to='/home_lingala' /> : language2 === "lingala" ?  <EnvoieAbonneInfo  setForceUpdate={setForceUpdate} setEnvoie3={setEnvoie3}  dataEnvoie3={dataEnvoie3} envoie={envoie} setEnvoie={setEnvoie} envoie3={envoie3} dataAbonne={dataAbonne} isAdmin={isAdmin} isStaff={isStaff} language2={language2} modalShowPasswordChange={modalShowPasswordChange} setModalShowPasswordChange={setModalShowPasswordChange} modalShowContact={modalShowContact} setModalShowContact={setModalShowContact} modalShow={modalShow} modalShow4={modalShow4} setModalShow={setModalShow} setModalShow4={setModalShow4} setLanguage={setLanguage} setLanguage2={setLanguage2} uniqueNumber={uniqueNumber} setUniqueNumber={setUniqueNumber} setUsername={setUsername} setIsadmin={setIsadmin} setIsStaff={setIsStaff} setIsLogged={setIsLogged} isLogged={isLogged} username={username} language={language}/> : language2 === "english" ? <Navigate to='/envoi_abonne_info_english' /> : <Navigate to='/envoi_abonne_info_french' />} >
        </Route>


        <Route path="/confirmation_envoie_info" element={abonne.infoAbonne.numero_expediteur == "" ? <Navigate to='/home_lingala' /> : language2 === "lingala" ? <ConfirmationEnvoieInfo clientForm={clientForm} setEnvoie3={setEnvoie3} setClientForm={setClientForm} saveAbonne={saveAbonne} setAbonne={setAbonne} abonne={abonne} setSaveAbonne={setSaveAbonne}  modalShowEnvoi={modalShowEnvoi} setModalShowEnvoi={setModalShowEnvoi} envoie3={envoie3} dataAbonne={dataAbonne} isAdmin={isAdmin} isStaff={isStaff} language2={language2} modalShowPasswordChange={modalShowPasswordChange} setModalShowPasswordChange={setModalShowPasswordChange} modalShowContact={modalShowContact} setModalShowContact={setModalShowContact} modalShow={modalShow} modalShow4={modalShow4} setModalShow={setModalShow} setModalShow4={setModalShow4} setLanguage={setLanguage} setLanguage2={setLanguage2} uniqueNumber={uniqueNumber} setUniqueNumber={setUniqueNumber} setUsername={setUsername} setIsadmin={setIsadmin} setIsStaff={setIsStaff} setIsLogged={setIsLogged} isLogged={isLogged} username={username} language={language}/> : language2 === "english" ? <Navigate to='/confirmation_envoie_info_english' /> : <Navigate to='/confirmation_envoie_info_french' />} >
        </Route>

        <Route path="/retrait_info" element={abonne.infoAbonne.numero_expediteur == "" ? <Navigate to='/home_lingala' /> : language2 === "lingala" ?  <ConfirmationRetraitInfo abonne={abonne} envoie2={envoie2} dataAbonne={dataAbonne} envoie3={envoie3} isAdmin={isAdmin} isStaff={isStaff} language2={language2} modalShowPasswordChange={modalShowPasswordChange} setModalShowPasswordChange={setModalShowPasswordChange} modalShowContact={modalShowContact} setModalShowContact={setModalShowContact} modalShow={modalShow} modalShow4={modalShow4} setModalShow={setModalShow} setModalShow4={setModalShow4} setLanguage={setLanguage} setLanguage2={setLanguage2} uniqueNumber={uniqueNumber} setUniqueNumber={setUniqueNumber} setUsername={setUsername} setIsadmin={setIsadmin} setIsStaff={setIsStaff} setIsLogged={setIsLogged} isLogged={isLogged} username={username} language={language}/> : language2 === "english" ? <Navigate to='/retrait_info_english' /> : <Navigate to='/retrait_info_french' />} >
        </Route>
        ...
        <Route path="/form_envoie_abonne_id_french" element={language2 === "french" ? <FormEnvoiAbonneIdFrench dataAbonne={dataAbonne} setReceiver={setReceiver} setAbonne={setAbonne} abonne={abonne}  modalShowEnvoi={modalShowEnvoi} setModalShowEnvoi={setModalShowEnvoi}  envoie3={envoie3} isAdmin={isAdmin} isStaff={isStaff} language2={language2} modalShowPasswordChange={modalShowPasswordChange} setModalShowPasswordChange={setModalShowPasswordChange} modalShowContact={modalShowContact} setModalShowContact={setModalShowContact} modalShow={modalShow} modalShow4={modalShow4} setModalShow={setModalShow} setModalShow4={setModalShow4} setLanguage={setLanguage} setLanguage2={setLanguage2} uniqueNumber={uniqueNumber} setUniqueNumber={setUniqueNumber} setUsername={setUsername} setIsadmin={setIsadmin} setIsStaff={setIsStaff} setIsLogged={setIsLogged} isLogged={isLogged} username={username} language={language} /> : language2 === "lingala" ? <Navigate to='/form_envoie_abonne_id' /> : <Navigate to='/form_envoie_abonne_id_english' />} >
        </Route>

        <Route path="/form_envoie_abonne_french" element={abonne.infoAbonne.numero_expediteur == "" ? <Navigate to='/home_french' /> : language2 === "french" ? <FormEnvoiAbonneFrench  setAbonne={setAbonne} abonne={abonne} receiver={receiver} envoie={envoie} envoie3={envoie3} setEnvoie={setEnvoie} dataEnvoieAbonne={dataEnvoieAbonne} taux={taux} setTaux={setTaux} dataAbonne={dataAbonne} isAdmin={isAdmin} isStaff={isStaff} language2={language2} modalShowPasswordChange={modalShowPasswordChange} setModalShowPasswordChange={setModalShowPasswordChange} modalShowContact={modalShowContact} setModalShowContact={setModalShowContact} modalShow={modalShow} modalShow4={modalShow4} setModalShow={setModalShow} setModalShow4={setModalShow4} setLanguage={setLanguage} setLanguage2={setLanguage2} uniqueNumber={uniqueNumber} setUniqueNumber={setUniqueNumber} setUsername={setUsername} setIsadmin={setIsadmin} setIsStaff={setIsStaff} setIsLogged={setIsLogged} isLogged={isLogged} username={username} language={language}/>  : language2 === "lingala" ? <Navigate to='/form_envoie_abonne' /> : <Navigate to='/form_envoie_abonne_english' />} >
        </Route>

        <Route path="/form_retrait_info_french" element={abonne.infoAbonne.numero_expediteur  == "" ? <Navigate to='/home_french' /> : language2 === "french" ? <FormRetraitFrench  dataEnvoie2={dataEnvoie2} envoie3={envoie3} dataAbonne={dataAbonne} abonne={abonne} setAbonne={setAbonne} isAdmin={isAdmin} isStaff={isStaff} language2={language2} modalShowPasswordChange={modalShowPasswordChange} setModalShowPasswordChange={setModalShowPasswordChange} modalShowContact={modalShowContact} setModalShowContact={setModalShowContact} modalShow={modalShow} modalShow4={modalShow4} setModalShow={setModalShow} setModalShow4={setModalShow4} setLanguage={setLanguage} setLanguage2={setLanguage2} uniqueNumber={uniqueNumber} setUniqueNumber={setUniqueNumber} setUsername={setUsername} setIsadmin={setIsadmin} setIsStaff={setIsStaff} setIsLogged={setIsLogged} isLogged={isLogged} username={username} language={language}/>: language2 === "lingala" ? <Navigate to='/form_retrait_info' /> : <Navigate to='/form_retrait_info_english' />} >
        </Route>
        ...
        <Route path="/envoi_abonne_info_french" element={abonne.infoAbonne.numero_expediteur  == "" ? <Navigate to='/home_french' /> : language2 === "french" ? <EnvoieAbonneInfoFrench   setEnvoie3={setEnvoie3}  dataEnvoie3={dataEnvoie3} envoie={envoie} setEnvoie={setEnvoie} envoie3={envoie3} dataAbonne={dataAbonne} isAdmin={isAdmin} isStaff={isStaff} language2={language2} modalShowPasswordChange={modalShowPasswordChange} setModalShowPasswordChange={setModalShowPasswordChange} modalShowContact={modalShowContact} setModalShowContact={setModalShowContact} modalShow={modalShow} modalShow4={modalShow4} setModalShow={setModalShow} setModalShow4={setModalShow4} setLanguage={setLanguage} setLanguage2={setLanguage2} uniqueNumber={uniqueNumber} setUniqueNumber={setUniqueNumber} setUsername={setUsername} setIsadmin={setIsadmin} setIsStaff={setIsStaff} setIsLogged={setIsLogged} isLogged={isLogged} username={username} language={language}/> : language2 === "lingala" ? <Navigate to='/envoi_abonne_info' /> : <Navigate to='/envoi_abonne_info_english' />} >
        </Route>


        <Route path="/confirmation_envoie_info_french" element={abonne.infoAbonne.numero_expediteur  == "" ? <Navigate to='/home_french' /> : language2 === "french" ?  <ConfirmationEnvoieInfoFrench   clientForm={clientForm} setClientForm={setClientForm}  saveAbonne={saveAbonne} setSaveAbonne={setSaveAbonne} setAbonne={setAbonne}  modalShowEnvoi={modalShowEnvoi} setModalShowEnvoi={setModalShowEnvoi} envoie3={envoie3} setEnvoie3={setEnvoie3} dataAbonne={dataAbonne} isAdmin={isAdmin} isStaff={isStaff} language2={language2} modalShowPasswordChange={modalShowPasswordChange} setModalShowPasswordChange={setModalShowPasswordChange} modalShowContact={modalShowContact} setModalShowContact={setModalShowContact} modalShow={modalShow} modalShow4={modalShow4} setModalShow={setModalShow} setModalShow4={setModalShow4} setLanguage={setLanguage} setLanguage2={setLanguage2} uniqueNumber={uniqueNumber} setUniqueNumber={setUniqueNumber} setUsername={setUsername} setIsadmin={setIsadmin} setIsStaff={setIsStaff} setIsLogged={setIsLogged} isLogged={isLogged} username={username} language={language}/> : language2 === "lingala" ? <Navigate to='/confirmation_envoie_info' /> : <Navigate to='/confirmation_envoie_info_english' />} >
        </Route>

        <Route path="/retrait_info_french" element={abonne.infoAbonne.numero_expediteur  == "" ? <Navigate to='/home_french' /> : language2 === "french" ?  <ConfirmationRetraitInfoFrench   abonne={abonne} envoie2={envoie2} dataAbonne={dataAbonne} envoie3={envoie3} isAdmin={isAdmin} isStaff={isStaff} language2={language2} modalShowPasswordChange={modalShowPasswordChange} setModalShowPasswordChange={setModalShowPasswordChange} modalShowContact={modalShowContact} setModalShowContact={setModalShowContact} modalShow={modalShow} modalShow4={modalShow4} setModalShow={setModalShow} setModalShow4={setModalShow4} setLanguage={setLanguage} setLanguage2={setLanguage2} uniqueNumber={uniqueNumber} setUniqueNumber={setUniqueNumber} setUsername={setUsername} setIsadmin={setIsadmin} setIsStaff={setIsStaff} setIsLogged={setIsLogged} isLogged={isLogged} username={username} language={language}/> : language2 === "lingala" ? <Navigate to='/retrait_info' /> : <Navigate to='/retrait_info_english' />} >
        </Route>
        ...
        <Route path="/select_year_form_retrait_french" element={username == "" ? <Navigate to='/home_french' /> : language2 === "french" ?  <SelectYearFormRetraitFrench username={username} dataYearlyRapport={dataYearlyRapport} dataMonthlyRapport={dataMonthlyRapport} setYear={setYear} setMois={setMois} setIsadmin={setIsadmin} isAdmin={isAdmin} dataAbonne={dataAbonne}  isStaff={isStaff} language2={language2} modalShowPasswordChange={modalShowPasswordChange} setModalShowPasswordChange={setModalShowPasswordChange} modalShowContact={modalShowContact} setModalShowContact={setModalShowContact} modalShow={modalShow} modalShow4={modalShow4} setModalShow={setModalShow} setModalShow4={setModalShow4} setLanguage={setLanguage} setLanguage2={setLanguage2} uniqueNumber={uniqueNumber} setUniqueNumber={setUniqueNumber} setUsername={setUsername}  setIsStaff={setIsStaff} setIsLogged={setIsLogged} isLogged={isLogged}  language={language}/> : language2 === "lingala" ? <Navigate to='/select_year_form_retrait_lingala' /> : <Navigate to='/select_year_form_retrait_english' />} >
        </Route>
        <Route path="/select_year_form_retrait_lingala" element={username == "" ? <Navigate to='/home_lingala' /> : language2 === "lingala" ?  <SelectYearFormRetraitLingala username={username} dataYearlyRapport={dataYearlyRapport} dataMonthlyRapport={dataMonthlyRapport} setMois={setMois} setYear={setYear} setIsadmin={setIsadmin} isAdmin={isAdmin} dataAbonne={dataAbonne}  isStaff={isStaff} language2={language2} modalShowPasswordChange={modalShowPasswordChange} setModalShowPasswordChange={setModalShowPasswordChange} modalShowContact={modalShowContact} setModalShowContact={setModalShowContact} modalShow={modalShow} modalShow4={modalShow4} setModalShow={setModalShow} setModalShow4={setModalShow4} setLanguage={setLanguage} setLanguage2={setLanguage2} uniqueNumber={uniqueNumber} setUniqueNumber={setUniqueNumber} setUsername={setUsername}  setIsStaff={setIsStaff} setIsLogged={setIsLogged} isLogged={isLogged}  language={language}/> : language2 === "english" ? <Navigate to='/select_year_form_retrait_english' /> : <Navigate to='/select_year_form_retrait_french' />} >
        </Route>
        <Route path="/select_year_form_retrait_english" element={username == "" ? <Navigate to='/' /> : language2 === "english" ?  <SelectYearFormRetraitEnglish username={username} dataYearlyRapport={dataYearlyRapport} dataMonthlyRapport={dataMonthlyRapport} setMois={setMois} setYear={setYear} setIsadmin={setIsadmin} isAdmin={isAdmin} dataAbonne={dataAbonne}  isStaff={isStaff} language2={language2} modalShowPasswordChange={modalShowPasswordChange} setModalShowPasswordChange={setModalShowPasswordChange} modalShowContact={modalShowContact} setModalShowContact={setModalShowContact} modalShow={modalShow} modalShow4={modalShow4} setModalShow={setModalShow} setModalShow4={setModalShow4} setLanguage={setLanguage} setLanguage2={setLanguage2} uniqueNumber={uniqueNumber} setUniqueNumber={setUniqueNumber} setUsername={setUsername}  setIsStaff={setIsStaff} setIsLogged={setIsLogged} isLogged={isLogged}  language={language}/> : language2 === "lingala" ? <Navigate to='/select_year_form_retrait_lingala' /> : <Navigate to='/select_year_form_retrait_french' />} >
        </Route>
        ...
        <Route path="/select_year_rapport_recette" element={username == "" ? <Navigate to='/home_french' /> : language2 === "french" ?  <SelectYearFormRecetteFrench username={username} dataYearlyRapport={dataYearlyRapport} dataMonthlyRapport={dataMonthlyRapport} setYear={setYear} setMois={setMois} setIsadmin={setIsadmin} isAdmin={isAdmin} dataAbonne={dataAbonne}  isStaff={isStaff} language2={language2} modalShowPasswordChange={modalShowPasswordChange} setModalShowPasswordChange={setModalShowPasswordChange} modalShowContact={modalShowContact} setModalShowContact={setModalShowContact} modalShow={modalShow} modalShow4={modalShow4} setModalShow={setModalShow} setModalShow4={setModalShow4} setLanguage={setLanguage} setLanguage2={setLanguage2} uniqueNumber={uniqueNumber} setUniqueNumber={setUniqueNumber} setUsername={setUsername}  setIsStaff={setIsStaff} setIsLogged={setIsLogged} isLogged={isLogged}  language={language}/> : language2 === "lingala" ? <Navigate to='/select_year_rapport_recette_lingala' /> : <Navigate to='/select_year_rapport_recette_english' />} >
        </Route>
        <Route path="/select_year_rapport_recette_lingala" element={username == "" ? <Navigate to='/home_lingala' /> : language2 === "lingala" ?  <SelectYearFormRecetteLingala username={username} dataYearlyRapport={dataYearlyRapport} dataMonthlyRapport={dataMonthlyRapport} setMois={setMois} setYear={setYear} setIsadmin={setIsadmin} isAdmin={isAdmin} dataAbonne={dataAbonne}  isStaff={isStaff} language2={language2} modalShowPasswordChange={modalShowPasswordChange} setModalShowPasswordChange={setModalShowPasswordChange} modalShowContact={modalShowContact} setModalShowContact={setModalShowContact} modalShow={modalShow} modalShow4={modalShow4} setModalShow={setModalShow} setModalShow4={setModalShow4} setLanguage={setLanguage} setLanguage2={setLanguage2} uniqueNumber={uniqueNumber} setUniqueNumber={setUniqueNumber} setUsername={setUsername}  setIsStaff={setIsStaff} setIsLogged={setIsLogged} isLogged={isLogged}  language={language}/> : language2 === "english" ? <Navigate to='/select_year_rapport_recette_english' /> : <Navigate to='/select_year_rapport_recette' />} >
        </Route>
        <Route path="/select_year_rapport_recette_english" element={username == "" ? <Navigate to='/' /> : language2 === "english" ?  <SelectYearFormRecetteEnglish username={username} dataYearlyRapport={dataYearlyRapport} dataMonthlyRapport={dataMonthlyRapport} setMois={setMois} setYear={setYear} setIsadmin={setIsadmin} isAdmin={isAdmin} dataAbonne={dataAbonne}  isStaff={isStaff} language2={language2} modalShowPasswordChange={modalShowPasswordChange} setModalShowPasswordChange={setModalShowPasswordChange} modalShowContact={modalShowContact} setModalShowContact={setModalShowContact} modalShow={modalShow} modalShow4={modalShow4} setModalShow={setModalShow} setModalShow4={setModalShow4} setLanguage={setLanguage} setLanguage2={setLanguage2} uniqueNumber={uniqueNumber} setUniqueNumber={setUniqueNumber} setUsername={setUsername}  setIsStaff={setIsStaff} setIsLogged={setIsLogged} isLogged={isLogged}  language={language}/> : language2 === "lingala" ? <Navigate to='/select_year_rapport_recette_lingala' /> : <Navigate to='/select_year_rapport_recette' />} >
        </Route>



        <Route path="/daily_rapport_envoi_french" element={username == "" ? <Navigate to='/home_french' /> : language2 === "french" ?  <DailyRapportInfoEnvoiFrench setMessage2={setMessage2} setTitleFrench={setTitleFrench} setTitleLingala={setTitleLingala} setTitleEnglish={setTitleEnglish} setRapportType={setRapportType} username={username} dailyRapport={dailyRapport} dataDetailEnvoieTotalTableau={dataDetailEnvoieTotalTableau} dataDetailEnvoieTotal={dataDetailEnvoieTotal} dateInfo={dateInfo} setIsadmin={setIsadmin} isAdmin={isAdmin} dataAbonne={dataAbonne}  isStaff={isStaff} language2={language2} modalShowPasswordChange={modalShowPasswordChange} setModalShowPasswordChange={setModalShowPasswordChange} modalShowContact={modalShowContact} setModalShowContact={setModalShowContact} modalShow={modalShow} modalShow4={modalShow4} setModalShow={setModalShow} setModalShow4={setModalShow4} setLanguage={setLanguage} setLanguage2={setLanguage2} uniqueNumber={uniqueNumber} setUniqueNumber={setUniqueNumber} setUsername={setUsername}  setIsStaff={setIsStaff} setIsLogged={setIsLogged} isLogged={isLogged}  language={language}/> : language2 === "lingala" ? <Navigate to='/daily_rapport_envoi_lingala' /> : <Navigate to='/daily_rapport_envoi_english' />} >
        </Route>
        <Route path="/daily_rapport_envoi_lingala" element={username == "" ? <Navigate to='/home_lingala' /> : language2 === "lingala" ?  <DailyRapportInfoEnvoiLingala setMessage2={setMessage2} setTitleFrench={setTitleFrench} setTitleLingala={setTitleLingala} setTitleEnglish={setTitleEnglish} setRapportType={setRapportType} username={username} dailyRapport={dailyRapport} dataDetailEnvoieTotalTableau={dataDetailEnvoieTotalTableau} dataDetailEnvoieTotal={dataDetailEnvoieTotal} dateInfo={dateInfo} setIsadmin={setIsadmin} isAdmin={isAdmin} dataAbonne={dataAbonne}  isStaff={isStaff} language2={language2} modalShowPasswordChange={modalShowPasswordChange} setModalShowPasswordChange={setModalShowPasswordChange} modalShowContact={modalShowContact} setModalShowContact={setModalShowContact} modalShow={modalShow} modalShow4={modalShow4} setModalShow={setModalShow} setModalShow4={setModalShow4} setLanguage={setLanguage} setLanguage2={setLanguage2} uniqueNumber={uniqueNumber} setUniqueNumber={setUniqueNumber} setUsername={setUsername}  setIsStaff={setIsStaff} setIsLogged={setIsLogged} isLogged={isLogged}  language={language}/>: language2 === "english" ? <Navigate to='/daily_rapport_envoi_english' /> : <Navigate to='/daily_rapport_envoi_french' />} >
        </Route>
        <Route path="/daily_rapport_envoi_english" element={username == "" ? <Navigate to='/' /> : language2 === "english" ?  <DailyRapportInfoEnvoiEnglish setMessage2={setMessage2} setTitleFrench={setTitleFrench} setTitleLingala={setTitleLingala} setTitleEnglish={setTitleEnglish} username={username} setRapportType={setRapportType} dailyRapport={dailyRapport} dataDetailEnvoieTotalTableau={dataDetailEnvoieTotalTableau} dataDetailEnvoieTotal={dataDetailEnvoieTotal} dateInfo={dateInfo} setIsadmin={setIsadmin} isAdmin={isAdmin} dataAbonne={dataAbonne}  isStaff={isStaff} language2={language2} modalShowPasswordChange={modalShowPasswordChange} setModalShowPasswordChange={setModalShowPasswordChange} modalShowContact={modalShowContact} setModalShowContact={setModalShowContact} modalShow={modalShow} modalShow4={modalShow4} setModalShow={setModalShow} setModalShow4={setModalShow4} setLanguage={setLanguage} setLanguage2={setLanguage2} uniqueNumber={uniqueNumber} setUniqueNumber={setUniqueNumber} setUsername={setUsername}  setIsStaff={setIsStaff} setIsLogged={setIsLogged} isLogged={isLogged}  language={language}/>: language2 === "lingala" ? <Navigate to='/daily_rapport_envoi_lingala' /> : <Navigate to='/daily_rapport_envoi_french' />} >
        </Route>
       



        <Route path="/monthly_rapport_envoi_french" element={username == "" ? <Navigate to='/home_french' /> : language2 === "french" ? <MonthlyRapportInfoEnvoiFrench setMessage2={setMessage2} setTitleFrench={setTitleFrench} setTitleLingala={setTitleLingala} setTitleEnglish={setTitleEnglish} setRapportType={setRapportType} username={username} monthlyRapport={monthlyRapport} dataDetailEnvoieTotalTableau={dataDetailEnvoieTotalTableau} dataDetailEnvoieTotal={dataDetailEnvoieTotal} moisInfo={moisInfo} setIsadmin={setIsadmin} isAdmin={isAdmin} dataAbonne={dataAbonne} isStaff={isStaff} language2={language2} modalShowPasswordChange={modalShowPasswordChange} setModalShowPasswordChange={setModalShowPasswordChange} modalShowContact={modalShowContact} setModalShowContact={setModalShowContact} modalShow={modalShow} modalShow4={modalShow4} setModalShow={setModalShow} setModalShow4={setModalShow4} setLanguage={setLanguage} setLanguage2={setLanguage2} uniqueNumber={uniqueNumber} setUniqueNumber={setUniqueNumber} setUsername={setUsername}  setIsStaff={setIsStaff} setIsLogged={setIsLogged} isLogged={isLogged}  language={language}/>: language2 === "lingala" ? <Navigate to='/monthly_rapport_envoi_lingala' /> : <Navigate to='/monthly_rapport_envoi_english' />} >
        </Route>
        <Route path="/monthly_rapport_envoi_lingala" element={username == "" ? <Navigate to='/home_lingala' /> : language2 === "lingala" ? <MonthlyRapportInfoEnvoiLingala setMessage2={setMessage2} setTitleFrench={setTitleFrench} setTitleLingala={setTitleLingala} setTitleEnglish={setTitleEnglish} setRapportType={setRapportType} username={username} monthlyRapport={monthlyRapport} dataDetailEnvoieTotalTableau={dataDetailEnvoieTotalTableau} dataDetailEnvoieTotal={dataDetailEnvoieTotal} moisInfo={moisInfo} setIsadmin={setIsadmin} isAdmin={isAdmin} dataAbonne={dataAbonne} isStaff={isStaff} language2={language2} modalShowPasswordChange={modalShowPasswordChange} setModalShowPasswordChange={setModalShowPasswordChange} modalShowContact={modalShowContact} setModalShowContact={setModalShowContact} modalShow={modalShow} modalShow4={modalShow4} setModalShow={setModalShow} setModalShow4={setModalShow4} setLanguage={setLanguage} setLanguage2={setLanguage2} uniqueNumber={uniqueNumber} setUniqueNumber={setUniqueNumber} setUsername={setUsername}  setIsStaff={setIsStaff} setIsLogged={setIsLogged} isLogged={isLogged}  language={language}/>: language2 === "english" ? <Navigate to='/monthly_rapport_envoi_english' /> : <Navigate to='/monthly_rapport_envoi_french' />} >
        </Route>
        <Route path="/monthly_rapport_envoi_english" element={username == "" ? <Navigate to='/' /> : language2 === "english" ? <MonthlyRapportInfoEnvoiEnglish setMessage2={setMessage2} setTitleFrench={setTitleFrench} setTitleLingala={setTitleLingala} setTitleEnglish={setTitleEnglish} username={username} setRapportType={setRapportType} monthlyRapport={monthlyRapport} dataDetailEnvoieTotalTableau={dataDetailEnvoieTotalTableau} dataDetailEnvoieTotal={dataDetailEnvoieTotal} moisInfo={moisInfo} setIsadmin={setIsadmin} isAdmin={isAdmin} dataAbonne={dataAbonne} isStaff={isStaff} language2={language2} modalShowPasswordChange={modalShowPasswordChange} setModalShowPasswordChange={setModalShowPasswordChange} modalShowContact={modalShowContact} setModalShowContact={setModalShowContact} modalShow={modalShow} modalShow4={modalShow4} setModalShow={setModalShow} setModalShow4={setModalShow4} setLanguage={setLanguage} setLanguage2={setLanguage2} uniqueNumber={uniqueNumber} setUniqueNumber={setUniqueNumber} setUsername={setUsername}  setIsStaff={setIsStaff} setIsLogged={setIsLogged} isLogged={isLogged}  language={language}/>: language2 === "lingala" ? <Navigate to='/monthly_rapport_envoi_lingala' /> : <Navigate to='/monthly_rapport_envoi_french' />} >
        </Route>


        <Route path="/yearly_rapport_envoi_french" element={username == "" ? <Navigate to='/home_french' /> : language2 === "french" ? <YearlyRapportInfoEnvoiFrench setMessage2={setMessage2} setTitleFrench={setTitleFrench} setTitleLingala={setTitleLingala} setTitleEnglish={setTitleEnglish} setRapportType={setRapportType} username={username} yearlyRapport={yearlyRapport} yearInfo={yearInfo} monthlyRapport={monthlyRapport} dataDetailEnvoieTotalTableau={dataDetailEnvoieTotalTableau} dataDetailEnvoieTotal={dataDetailEnvoieTotal} moisInfo={moisInfo} setIsadmin={setIsadmin} isAdmin={isAdmin} dataAbonne={dataAbonne} isStaff={isStaff} language2={language2} modalShowPasswordChange={modalShowPasswordChange} setModalShowPasswordChange={setModalShowPasswordChange} modalShowContact={modalShowContact} setModalShowContact={setModalShowContact} modalShow={modalShow} modalShow4={modalShow4} setModalShow={setModalShow} setModalShow4={setModalShow4} setLanguage={setLanguage} setLanguage2={setLanguage2} uniqueNumber={uniqueNumber} setUniqueNumber={setUniqueNumber} setUsername={setUsername}  setIsStaff={setIsStaff} setIsLogged={setIsLogged} isLogged={isLogged}  language={language}/>: language2 === "lingala" ? <Navigate to='/yearly_rapport_envoi_lingala' /> : <Navigate to='/yearly_rapport_envoi_english' />} >
        </Route>
        <Route path="/yearly_rapport_envoi_lingala" element={username == "" ? <Navigate to='/home_lingala' /> : language2 === "lingala" ? <YearlyRapportInfoEnvoiLingala setMessage2={setMessage2} setTitleFrench={setTitleFrench} setTitleLingala={setTitleLingala} setTitleEnglish={setTitleEnglish} setRapportType={setRapportType} username={username} yearlyRapport={yearlyRapport} yearInfo={yearInfo} monthlyRapport={monthlyRapport} dataDetailEnvoieTotalTableau={dataDetailEnvoieTotalTableau} dataDetailEnvoieTotal={dataDetailEnvoieTotal} moisInfo={moisInfo} setIsadmin={setIsadmin} isAdmin={isAdmin} dataAbonne={dataAbonne} isStaff={isStaff} language2={language2} modalShowPasswordChange={modalShowPasswordChange} setModalShowPasswordChange={setModalShowPasswordChange} modalShowContact={modalShowContact} setModalShowContact={setModalShowContact} modalShow={modalShow} modalShow4={modalShow4} setModalShow={setModalShow} setModalShow4={setModalShow4} setLanguage={setLanguage} setLanguage2={setLanguage2} uniqueNumber={uniqueNumber} setUniqueNumber={setUniqueNumber} setUsername={setUsername}  setIsStaff={setIsStaff} setIsLogged={setIsLogged} isLogged={isLogged}  language={language}/>: language2 === "english" ? <Navigate to='/yearly_rapport_envoi_english' /> : <Navigate to='/yearly_rapport_envoi_french' />} >
        </Route>
        <Route path="/yearly_rapport_envoi_english" element={username == "" ? <Navigate to='/' /> : language2 === "english" ? <YearlyRapportInfoEnvoiEnglish setMessage2={setMessage2} setTitleFrench={setTitleFrench} setTitleLingala={setTitleLingala} setTitleEnglish={setTitleEnglish} username={username} setRapportType={setRapportType} yearlyRapport={yearlyRapport} yearInfo={yearInfo} monthlyRapport={monthlyRapport} dataDetailEnvoieTotalTableau={dataDetailEnvoieTotalTableau} dataDetailEnvoieTotal={dataDetailEnvoieTotal} moisInfo={moisInfo} setIsadmin={setIsadmin} isAdmin={isAdmin} dataAbonne={dataAbonne} isStaff={isStaff} language2={language2} modalShowPasswordChange={modalShowPasswordChange} setModalShowPasswordChange={setModalShowPasswordChange} modalShowContact={modalShowContact} setModalShowContact={setModalShowContact} modalShow={modalShow} modalShow4={modalShow4} setModalShow={setModalShow} setModalShow4={setModalShow4} setLanguage={setLanguage} setLanguage2={setLanguage2} uniqueNumber={uniqueNumber} setUniqueNumber={setUniqueNumber} setUsername={setUsername}  setIsStaff={setIsStaff} setIsLogged={setIsLogged} isLogged={isLogged}  language={language}/>: language2 === "lingala" ? <Navigate to='/yearly_rapport_envoi_lingala' /> : <Navigate to='/yearly_rapport_envoi_french' />} >
        </Route>
       
       


        <Route path="/daily_rapport_retrait_french" element={username == "" ? <Navigate to='/home_french' /> : language2 === "french" ? <DailyRapportInfoRetraitFrench setMessage2={setMessage2} setTitleFrench={setTitleFrench} setTitleLingala={setTitleLingala} setTitleEnglish={setTitleEnglish} setRapportType={setRapportType} username={username} dataDetailEnvoieTotalTableau={dataDetailEnvoieTotalTableau} dailyRapport={dailyRapport} dataDetailEnvoieTotal={dataDetailEnvoieTotal} dateInfo={dateInfo} setIsadmin={setIsadmin} isAdmin={isAdmin} dataAbonne={dataAbonne}  isStaff={isStaff} language2={language2} modalShowPasswordChange={modalShowPasswordChange} setModalShowPasswordChange={setModalShowPasswordChange} modalShowContact={modalShowContact} setModalShowContact={setModalShowContact} modalShow={modalShow} modalShow4={modalShow4} setModalShow={setModalShow} setModalShow4={setModalShow4} setLanguage={setLanguage} setLanguage2={setLanguage2} uniqueNumber={uniqueNumber} setUniqueNumber={setUniqueNumber} setUsername={setUsername}  setIsStaff={setIsStaff} setIsLogged={setIsLogged} isLogged={isLogged}  language={language}/> : language2 === "lingala" ? <Navigate to='/daily_rapport_retrait_lingala' /> : <Navigate to='/daily_rapport_retrait_english' />} >
        </Route>
        <Route path="/daily_rapport_retrait_lingala" element={username == "" ? <Navigate to='/home_lingala' /> : language2 === "lingala" ? <DailyRapportInfoRetraitLingala setMessage2={setMessage2} setTitleFrench={setTitleFrench} setTitleLingala={setTitleLingala} setTitleEnglish={setTitleEnglish} setRapportType={setRapportType} username={username} dataDetailEnvoieTotalTableau={dataDetailEnvoieTotalTableau} dailyRapport={dailyRapport} dataDetailEnvoieTotal={dataDetailEnvoieTotal} dateInfo={dateInfo} setIsadmin={setIsadmin} isAdmin={isAdmin} dataAbonne={dataAbonne}  isStaff={isStaff} language2={language2} modalShowPasswordChange={modalShowPasswordChange} setModalShowPasswordChange={setModalShowPasswordChange} modalShowContact={modalShowContact} setModalShowContact={setModalShowContact} modalShow={modalShow} modalShow4={modalShow4} setModalShow={setModalShow} setModalShow4={setModalShow4} setLanguage={setLanguage} setLanguage2={setLanguage2} uniqueNumber={uniqueNumber} setUniqueNumber={setUniqueNumber} setUsername={setUsername}  setIsStaff={setIsStaff} setIsLogged={setIsLogged} isLogged={isLogged}  language={language}/> : language2 === "english" ? <Navigate to='/daily_rapport_retrait_english' /> : <Navigate to='/daily_rapport_retrait_french' />} >
        </Route>
        <Route path="/daily_rapport_retrait_english" element={username == "" ? <Navigate to='/' /> : language2 === "english" ? <DailyRapportInfoRetraitEnglish setMessage2={setMessage2} setTitleFrench={setTitleFrench} setTitleLingala={setTitleLingala} setTitleEnglish={setTitleEnglish} setRapportType={setRapportType} username={username} dataDetailEnvoieTotalTableau={dataDetailEnvoieTotalTableau} dailyRapport={dailyRapport} dataDetailEnvoieTotal={dataDetailEnvoieTotal} dateInfo={dateInfo} setIsadmin={setIsadmin} isAdmin={isAdmin} dataAbonne={dataAbonne}  isStaff={isStaff} language2={language2} modalShowPasswordChange={modalShowPasswordChange} setModalShowPasswordChange={setModalShowPasswordChange} modalShowContact={modalShowContact} setModalShowContact={setModalShowContact} modalShow={modalShow} modalShow4={modalShow4} setModalShow={setModalShow} setModalShow4={setModalShow4} setLanguage={setLanguage} setLanguage2={setLanguage2} uniqueNumber={uniqueNumber} setUniqueNumber={setUniqueNumber} setUsername={setUsername}  setIsStaff={setIsStaff} setIsLogged={setIsLogged} isLogged={isLogged}  language={language}/> : language2 === "lingala" ? <Navigate to='/daily_rapport_retrait_lingala' /> : <Navigate to='/daily_rapport_retrait_french' />} >
        </Route>



        <Route path="/monthly_rapport_retrait_french" element={username == "" ? <Navigate to='/home_french' /> : language2 === "french" ? <MonthlyRapportInfoRetraitFrench setMessage2={setMessage2} setTitleFrench={setTitleFrench} setTitleLingala={setTitleLingala} setTitleEnglish={setTitleEnglish} setRapportType={setRapportType} username={username} monthlyRapport={monthlyRapport} dataDetailEnvoieTotalTableau={dataDetailEnvoieTotalTableau} dataDetailEnvoieTotal={dataDetailEnvoieTotal} moisInfo={moisInfo} setIsadmin={setIsadmin} isAdmin={isAdmin} dataAbonne={dataAbonne} isStaff={isStaff} language2={language2} modalShowPasswordChange={modalShowPasswordChange} setModalShowPasswordChange={setModalShowPasswordChange} modalShowContact={modalShowContact} setModalShowContact={setModalShowContact} modalShow={modalShow} modalShow4={modalShow4} setModalShow={setModalShow} setModalShow4={setModalShow4} setLanguage={setLanguage} setLanguage2={setLanguage2} uniqueNumber={uniqueNumber} setUniqueNumber={setUniqueNumber} setUsername={setUsername}  setIsStaff={setIsStaff} setIsLogged={setIsLogged} isLogged={isLogged}  language={language}/> : language2 === "lingala" ? <Navigate to='/monthly_rapport_retrait_lingala' /> : <Navigate to='/monthly_rapport_retrait_english' />} >
        </Route>
        <Route path="/monthly_rapport_retrait_lingala" element={username == "" ? <Navigate to='/home_lingala' /> : language2 === "lingala" ? <MonthlyRapportInfoRetraitLingala setMessage2={setMessage2} setTitleFrench={setTitleFrench} setTitleLingala={setTitleLingala} setTitleEnglish={setTitleEnglish} setRapportType={setRapportType} username={username} monthlyRapport={monthlyRapport} dataDetailEnvoieTotalTableau={dataDetailEnvoieTotalTableau} dataDetailEnvoieTotal={dataDetailEnvoieTotal} moisInfo={moisInfo} setIsadmin={setIsadmin} isAdmin={isAdmin} dataAbonne={dataAbonne} isStaff={isStaff} language2={language2} modalShowPasswordChange={modalShowPasswordChange} setModalShowPasswordChange={setModalShowPasswordChange} modalShowContact={modalShowContact} setModalShowContact={setModalShowContact} modalShow={modalShow} modalShow4={modalShow4} setModalShow={setModalShow} setModalShow4={setModalShow4} setLanguage={setLanguage} setLanguage2={setLanguage2} uniqueNumber={uniqueNumber} setUniqueNumber={setUniqueNumber} setUsername={setUsername}  setIsStaff={setIsStaff} setIsLogged={setIsLogged} isLogged={isLogged}  language={language}/> : language2 === "english" ? <Navigate to='/monthly_rapport_retrait_english' /> : <Navigate to='/monthly_rapport_retrait_french' />} >
        </Route>
        ...
        <Route path="/yearly_rapport_retrait_french" element={username == "" ? <Navigate to='/home_french' /> : language2 === "french" ? <YearlyRapportInfoRetraitFrench setMessage2={setMessage2} setTitleFrench={setTitleFrench} setTitleLingala={setTitleLingala} setTitleEnglish={setTitleEnglish} setRapportType={setRapportType} username={username} yearlyRapport={yearlyRapport} yearInfo={yearInfo} monthlyRapport={monthlyRapport} dataDetailEnvoieTotalTableau={dataDetailEnvoieTotalTableau} dataDetailEnvoieTotal={dataDetailEnvoieTotal} moisInfo={moisInfo} setIsadmin={setIsadmin} isAdmin={isAdmin} dataAbonne={dataAbonne} isStaff={isStaff} language2={language2} modalShowPasswordChange={modalShowPasswordChange} setModalShowPasswordChange={setModalShowPasswordChange} modalShowContact={modalShowContact} setModalShowContact={setModalShowContact} modalShow={modalShow} modalShow4={modalShow4} setModalShow={setModalShow} setModalShow4={setModalShow4} setLanguage={setLanguage} setLanguage2={setLanguage2} uniqueNumber={uniqueNumber} setUniqueNumber={setUniqueNumber} setUsername={setUsername}  setIsStaff={setIsStaff} setIsLogged={setIsLogged} isLogged={isLogged}  language={language}/>: language2 === "lingala" ? <Navigate to='/yearly_rapport_retrait_lingala' /> : <Navigate to='/yearly_rapport_retrait_english' />} >
        </Route>
        <Route path="/yearly_rapport_retrait_lingala" element={username == "" ? <Navigate to='/home_lingala' /> : language2 === "lingala" ? <YearlyRapportInfoRetraitLingala setMessage2={setMessage2} setTitleFrench={setTitleFrench} setTitleLingala={setTitleLingala} setTitleEnglish={setTitleEnglish} setRapportType={setRapportType} username={username} yearlyRapport={yearlyRapport} yearInfo={yearInfo} monthlyRapport={monthlyRapport} dataDetailEnvoieTotalTableau={dataDetailEnvoieTotalTableau} dataDetailEnvoieTotal={dataDetailEnvoieTotal} moisInfo={moisInfo} setIsadmin={setIsadmin} isAdmin={isAdmin} dataAbonne={dataAbonne} isStaff={isStaff} language2={language2} modalShowPasswordChange={modalShowPasswordChange} setModalShowPasswordChange={setModalShowPasswordChange} modalShowContact={modalShowContact} setModalShowContact={setModalShowContact} modalShow={modalShow} modalShow4={modalShow4} setModalShow={setModalShow} setModalShow4={setModalShow4} setLanguage={setLanguage} setLanguage2={setLanguage2} uniqueNumber={uniqueNumber} setUniqueNumber={setUniqueNumber} setUsername={setUsername}  setIsStaff={setIsStaff} setIsLogged={setIsLogged} isLogged={isLogged}  language={language}/>: language2 === "english" ? <Navigate to='/yearly_rapport_retrait_english' /> : <Navigate to='/yearly_rapport_retrait_french' />} >
        </Route>
        <Route path="/yearly_rapport_retrait_english" element={username == "" ? <Navigate to='/' /> : language2 === "english" ? <YearlyRapportInfoRetraitEnglish setMessage2={setMessage2} setTitleFrench={setTitleFrench} setTitleLingala={setTitleLingala} setTitleEnglish={setTitleEnglish} username={username} setRapportType={setRapportType} yearlyRapport={yearlyRapport} yearInfo={yearInfo} monthlyRapport={monthlyRapport} dataDetailEnvoieTotalTableau={dataDetailEnvoieTotalTableau} dataDetailEnvoieTotal={dataDetailEnvoieTotal} moisInfo={moisInfo} setIsadmin={setIsadmin} isAdmin={isAdmin} dataAbonne={dataAbonne} isStaff={isStaff} language2={language2} modalShowPasswordChange={modalShowPasswordChange} setModalShowPasswordChange={setModalShowPasswordChange} modalShowContact={modalShowContact} setModalShowContact={setModalShowContact} modalShow={modalShow} modalShow4={modalShow4} setModalShow={setModalShow} setModalShow4={setModalShow4} setLanguage={setLanguage} setLanguage2={setLanguage2} uniqueNumber={uniqueNumber} setUniqueNumber={setUniqueNumber} setUsername={setUsername}  setIsStaff={setIsStaff} setIsLogged={setIsLogged} isLogged={isLogged}  language={language}/>: language2 === "lingala" ? <Navigate to='/yearly_rapport_retrait_lingala' /> : <Navigate to='/yearly_rapport_retrait_french' />} >
        </Route>



        <Route path="/daily_rapport_recette_french" element={username == "" ? <Navigate to='/home_french' /> : language2 === "french" ? <DailyRecettesFrench username={username} abonneInfoDetail={abonneInfoDetail} setTableType={setTableType}  dailyRapport={dailyRapport} dataDetailEnvoieTotal={dataDetailEnvoieTotal} dateInfo={dateInfo} setIsadmin={setIsadmin} isAdmin={isAdmin} dataAbonne={dataAbonne}  isStaff={isStaff} language2={language2} modalShowPasswordChange={modalShowPasswordChange} setModalShowPasswordChange={setModalShowPasswordChange} modalShowContact={modalShowContact} setModalShowContact={setModalShowContact} modalShow={modalShow} modalShow4={modalShow4} setModalShow={setModalShow} setModalShow4={setModalShow4} setLanguage={setLanguage} setLanguage2={setLanguage2} uniqueNumber={uniqueNumber} setUniqueNumber={setUniqueNumber} setUsername={setUsername}  setIsStaff={setIsStaff} setIsLogged={setIsLogged} isLogged={isLogged}  language={language}/> : language2 === "lingala" ? <Navigate to='/daily_rapport_recette_lingala' /> : <Navigate to='/daily_rapport_recette_english' />} >
        </Route>
        <Route path="/daily_rapport_recette_lingala" element={username == "" ? <Navigate to='/home_lingala' /> : language2 === "lingala" ? <DailyRecettesLingala username={username} abonneInfoDetail={abonneInfoDetail} setTableType={setTableType}  dailyRapport={dailyRapport} dataDetailEnvoieTotal={dataDetailEnvoieTotal} dateInfo={dateInfo} setIsadmin={setIsadmin} isAdmin={isAdmin} dataAbonne={dataAbonne}  isStaff={isStaff} language2={language2} modalShowPasswordChange={modalShowPasswordChange} setModalShowPasswordChange={setModalShowPasswordChange} modalShowContact={modalShowContact} setModalShowContact={setModalShowContact} modalShow={modalShow} modalShow4={modalShow4} setModalShow={setModalShow} setModalShow4={setModalShow4} setLanguage={setLanguage} setLanguage2={setLanguage2} uniqueNumber={uniqueNumber} setUniqueNumber={setUniqueNumber} setUsername={setUsername}  setIsStaff={setIsStaff} setIsLogged={setIsLogged} isLogged={isLogged}  language={language}/> : language2 === "english" ? <Navigate to='/daily_rapport_recette_english' /> : <Navigate to='/daily_rapport_recette_french' />} >
        </Route>
        <Route path="/daily_rapport_recette_english" element={username == "" ? <Navigate to='/' /> : language2 === "english" ? <DailyRecettesEnglish username={username} abonneInfoDetail={abonneInfoDetail} setTableType={setTableType}  dailyRapport={dailyRapport} dataDetailEnvoieTotal={dataDetailEnvoieTotal} dateInfo={dateInfo} setIsadmin={setIsadmin} isAdmin={isAdmin} dataAbonne={dataAbonne}  isStaff={isStaff} language2={language2} modalShowPasswordChange={modalShowPasswordChange} setModalShowPasswordChange={setModalShowPasswordChange} modalShowContact={modalShowContact} setModalShowContact={setModalShowContact} modalShow={modalShow} modalShow4={modalShow4} setModalShow={setModalShow} setModalShow4={setModalShow4} setLanguage={setLanguage} setLanguage2={setLanguage2} uniqueNumber={uniqueNumber} setUniqueNumber={setUniqueNumber} setUsername={setUsername}  setIsStaff={setIsStaff} setIsLogged={setIsLogged} isLogged={isLogged}  language={language}/> : language2 === "lingala" ? <Navigate to='/daily_rapport_recette_lingala' /> : <Navigate to='/daily_rapport_recette_french' />} >
        </Route>



        <Route path="/monthly_rapport_recette_french" element={username == "" ? <Navigate to='/home_french' /> : language2 === "french" ? <MonthlyRecettesFrench username={username} monthlyRapport={monthlyRapport} setTableType={setTableType} dataDetailEnvoieTotal={dataDetailEnvoieTotal} moisInfo={moisInfo} setIsadmin={setIsadmin} isAdmin={isAdmin} dataAbonne={dataAbonne} isStaff={isStaff} language2={language2} modalShowPasswordChange={modalShowPasswordChange} setModalShowPasswordChange={setModalShowPasswordChange} modalShowContact={modalShowContact} setModalShowContact={setModalShowContact} modalShow={modalShow} modalShow4={modalShow4} setModalShow={setModalShow} setModalShow4={setModalShow4} setLanguage={setLanguage} setLanguage2={setLanguage2} uniqueNumber={uniqueNumber} setUniqueNumber={setUniqueNumber} setUsername={setUsername}  setIsStaff={setIsStaff} setIsLogged={setIsLogged} isLogged={isLogged}  language={language}/> : language2 === "lingala" ? <Navigate to='/monthly_rapport_recette_lingala' /> : <Navigate to='/monthly_rapport_recette_english' />} >
        </Route>
        <Route path="/monthly_rapport_recette_lingala" element={username == "" ? <Navigate to='/home_lingala' /> : language2 === "lingala" ? <MonthlyRecettesLingala username={username} monthlyRapport={monthlyRapport} setTableType={setTableType} dataDetailEnvoieTotal={dataDetailEnvoieTotal} moisInfo={moisInfo} setIsadmin={setIsadmin} isAdmin={isAdmin} dataAbonne={dataAbonne} isStaff={isStaff} language2={language2} modalShowPasswordChange={modalShowPasswordChange} setModalShowPasswordChange={setModalShowPasswordChange} modalShowContact={modalShowContact} setModalShowContact={setModalShowContact} modalShow={modalShow} modalShow4={modalShow4} setModalShow={setModalShow} setModalShow4={setModalShow4} setLanguage={setLanguage} setLanguage2={setLanguage2} uniqueNumber={uniqueNumber} setUniqueNumber={setUniqueNumber} setUsername={setUsername}  setIsStaff={setIsStaff} setIsLogged={setIsLogged} isLogged={isLogged}  language={language}/> : language2 === "english" ? <Navigate to='/monthly_rapport_recette_english' /> : <Navigate to='/monthly_rapport_recette_french' />} >
        </Route>
        <Route path="/monthly_rapport_recette_english" element={username == "" ? <Navigate to='/' /> : language2 === "english" ? <MonthlyRecettesEnglish username={username} monthlyRapport={monthlyRapport} setTableType={setTableType} dataDetailEnvoieTotal={dataDetailEnvoieTotal} moisInfo={moisInfo} setIsadmin={setIsadmin} isAdmin={isAdmin} dataAbonne={dataAbonne} isStaff={isStaff} language2={language2} modalShowPasswordChange={modalShowPasswordChange} setModalShowPasswordChange={setModalShowPasswordChange} modalShowContact={modalShowContact} setModalShowContact={setModalShowContact} modalShow={modalShow} modalShow4={modalShow4} setModalShow={setModalShow} setModalShow4={setModalShow4} setLanguage={setLanguage} setLanguage2={setLanguage2} uniqueNumber={uniqueNumber} setUniqueNumber={setUniqueNumber} setUsername={setUsername}  setIsStaff={setIsStaff} setIsLogged={setIsLogged} isLogged={isLogged}  language={language}/> : language2 === "lingala" ? <Navigate to='/monthly_rapport_recette_lingala' /> : <Navigate to='/monthly_rapport_recette_french' />} >
        </Route>


        <Route path="/yearly_rapport_recette_french" element={username == "" ? <Navigate to='/home_french' /> : language2 === "french" ? <YearlyRecettesFrench username={username} yearlyRapport={yearlyRapport} yearInfo={yearInfo} monthlyRapport={monthlyRapport} setTableType={setTableType} dataDetailEnvoieTotal={dataDetailEnvoieTotal} moisInfo={moisInfo} setIsadmin={setIsadmin} isAdmin={isAdmin} dataAbonne={dataAbonne} isStaff={isStaff} language2={language2} modalShowPasswordChange={modalShowPasswordChange} setModalShowPasswordChange={setModalShowPasswordChange} modalShowContact={modalShowContact} setModalShowContact={setModalShowContact} modalShow={modalShow} modalShow4={modalShow4} setModalShow={setModalShow} setModalShow4={setModalShow4} setLanguage={setLanguage} setLanguage2={setLanguage2} uniqueNumber={uniqueNumber} setUniqueNumber={setUniqueNumber} setUsername={setUsername}  setIsStaff={setIsStaff} setIsLogged={setIsLogged} isLogged={isLogged}  language={language}/> : language2 === "lingala" ? <Navigate to='/yearly_rapport_recette_lingala' /> : <Navigate to='/yearly_rapport_recette_english' />} >
        </Route>
        <Route path="/yearly_rapport_recette_lingala" element={username == "" ? <Navigate to='/home_lingala' /> : language2 === "lingala" ? <YearlyRecettesLingala username={username} yearlyRapport={yearlyRapport} yearInfo={yearInfo} monthlyRapport={monthlyRapport} setTableType={setTableType} dataDetailEnvoieTotal={dataDetailEnvoieTotal} moisInfo={moisInfo} setIsadmin={setIsadmin} isAdmin={isAdmin} dataAbonne={dataAbonne} isStaff={isStaff} language2={language2} modalShowPasswordChange={modalShowPasswordChange} setModalShowPasswordChange={setModalShowPasswordChange} modalShowContact={modalShowContact} setModalShowContact={setModalShowContact} modalShow={modalShow} modalShow4={modalShow4} setModalShow={setModalShow} setModalShow4={setModalShow4} setLanguage={setLanguage} setLanguage2={setLanguage2} uniqueNumber={uniqueNumber} setUniqueNumber={setUniqueNumber} setUsername={setUsername}  setIsStaff={setIsStaff} setIsLogged={setIsLogged} isLogged={isLogged}  language={language}/> : language2 === "english" ? <Navigate to='/yearly_rapport_recette_english' /> : <Navigate to='/yearly_rapport_recette_french' />} >
        </Route>
        <Route path="/yearly_rapport_recette_english" element={username == "" ? <Navigate to='/' /> : language2 === "english" ? <YearlyRecettesEnglish username={username} yearlyRapport={yearlyRapport} yearInfo={yearInfo} monthlyRapport={monthlyRapport} setTableType={setTableType} dataDetailEnvoieTotal={dataDetailEnvoieTotal} moisInfo={moisInfo} setIsadmin={setIsadmin} isAdmin={isAdmin} dataAbonne={dataAbonne} isStaff={isStaff} language2={language2} modalShowPasswordChange={modalShowPasswordChange} setModalShowPasswordChange={setModalShowPasswordChange} modalShowContact={modalShowContact} setModalShowContact={setModalShowContact} modalShow={modalShow} modalShow4={modalShow4} setModalShow={setModalShow} setModalShow4={setModalShow4} setLanguage={setLanguage} setLanguage2={setLanguage2} uniqueNumber={uniqueNumber} setUniqueNumber={setUniqueNumber} setUsername={setUsername}  setIsStaff={setIsStaff} setIsLogged={setIsLogged} isLogged={isLogged}  language={language}/> : language2 === "lingala" ? <Navigate to='/yearly_rapport_recette_lingala' /> : <Navigate to='/yearly_rapport_recette_french' />} >
        </Route>
        ...
        <Route path="/table_daily_rapport_english" element={username == "" ? <Navigate to='/' /> : language2 === "english" ?  <TableDailyRapportEnglish setTableType={setTableType} titleEnglish={titleEnglish} rapportType={rapportType} message2={message2} username={username} detailEnvoieTotal={detailEnvoieTotal} detailEnvoieTotalTableau={detailEnvoieTotalTableau}  dailyRapport={dailyRapport} dataDetailEnvoieTotal={dataDetailEnvoieTotal} dateInfo={dateInfo} setIsadmin={setIsadmin} isAdmin={isAdmin} dataAbonne={dataAbonne}  isStaff={isStaff} language2={language2} modalShowPasswordChange={modalShowPasswordChange} setModalShowPasswordChange={setModalShowPasswordChange} modalShowContact={modalShowContact} setModalShowContact={setModalShowContact} modalShow={modalShow} modalShow4={modalShow4} setModalShow={setModalShow} setModalShow4={setModalShow4} setLanguage={setLanguage} setLanguage2={setLanguage2} uniqueNumber={uniqueNumber} setUniqueNumber={setUniqueNumber} setUsername={setUsername}  setIsStaff={setIsStaff} setIsLogged={setIsLogged} isLogged={isLogged}  language={language}/> : language2 === "lingala" ? <Navigate to='/table_daily_rapport_lingala' /> : <Navigate to='/table_daily_rapport_french' />} >
        </Route>
        <Route path="/table_daily_rapport_french" element={username == "" ? <Navigate to='/home_french' /> : language2 === "french" ?  <TableDailyRapportFrench setTableType={setTableType} titleFrench={titleFrench} rapportType={rapportType} message2={message2} username={username} detailEnvoieTotal={detailEnvoieTotal} detailEnvoieTotalTableau={detailEnvoieTotalTableau}  dailyRapport={dailyRapport} dataDetailEnvoieTotal={dataDetailEnvoieTotal} dateInfo={dateInfo} setIsadmin={setIsadmin} isAdmin={isAdmin} dataAbonne={dataAbonne}  isStaff={isStaff} language2={language2} modalShowPasswordChange={modalShowPasswordChange} setModalShowPasswordChange={setModalShowPasswordChange} modalShowContact={modalShowContact} setModalShowContact={setModalShowContact} modalShow={modalShow} modalShow4={modalShow4} setModalShow={setModalShow} setModalShow4={setModalShow4} setLanguage={setLanguage} setLanguage2={setLanguage2} uniqueNumber={uniqueNumber} setUniqueNumber={setUniqueNumber} setUsername={setUsername}  setIsStaff={setIsStaff} setIsLogged={setIsLogged} isLogged={isLogged}  language={language}/> : language2 === "lingala" ? <Navigate to='/table_daily_rapport_lingala' /> : <Navigate to='/table_daily_rapport_english' />} >
        </Route>
        <Route path="/table_daily_rapport_lingala" element={username == "" ? <Navigate to='/home_lingala' /> : language2 === "lingala" ?  <TableDailyRapportLingala setTableType={setTableType} titleLingala={titleLingala} rapportType={rapportType} message2={message2} username={username} detailEnvoieTotal={detailEnvoieTotal} detailEnvoieTotalTableau={detailEnvoieTotalTableau}  dailyRapport={dailyRapport} dataDetailEnvoieTotal={dataDetailEnvoieTotal} dateInfo={dateInfo} setIsadmin={setIsadmin} isAdmin={isAdmin} dataAbonne={dataAbonne}  isStaff={isStaff} language2={language2} modalShowPasswordChange={modalShowPasswordChange} setModalShowPasswordChange={setModalShowPasswordChange} modalShowContact={modalShowContact} setModalShowContact={setModalShowContact} modalShow={modalShow} modalShow4={modalShow4} setModalShow={setModalShow} setModalShow4={setModalShow4} setLanguage={setLanguage} setLanguage2={setLanguage2} uniqueNumber={uniqueNumber} setUniqueNumber={setUniqueNumber} setUsername={setUsername}  setIsStaff={setIsStaff} setIsLogged={setIsLogged} isLogged={isLogged}  language={language}/> : language2 === "english" ? <Navigate to='/table_daily_rapport_english' /> : <Navigate to='/table_daily_rapport_french' />} >
        </Route>


        <Route path="/table_monthly_rapport_english" element={username == "" ? <Navigate to='/' /> : language2 === "english" ? <TableMonthlyRapportEnglish setTableType={setTableType} titleEnglish={titleEnglish} username={username}  rapportType={rapportType} message2={message2} moisInfo={moisInfo} detailEnvoieTotal={detailEnvoieTotal} detailEnvoieTotalTableau={detailEnvoieTotalTableau}  dailyRapport={dailyRapport} dataDetailEnvoieTotal={dataDetailEnvoieTotal} dateInfo={dateInfo} setIsadmin={setIsadmin} isAdmin={isAdmin} dataAbonne={dataAbonne}  isStaff={isStaff} language2={language2} modalShowPasswordChange={modalShowPasswordChange} setModalShowPasswordChange={setModalShowPasswordChange} modalShowContact={modalShowContact} setModalShowContact={setModalShowContact} modalShow={modalShow} modalShow4={modalShow4} setModalShow={setModalShow} setModalShow4={setModalShow4} setLanguage={setLanguage} setLanguage2={setLanguage2} uniqueNumber={uniqueNumber} setUniqueNumber={setUniqueNumber} setUsername={setUsername}  setIsStaff={setIsStaff} setIsLogged={setIsLogged} isLogged={isLogged}  language={language}/> : language2 === "lingala" ? <Navigate to='/table_monthly_rapport_lingala' /> : <Navigate to='/table_monthly_rapport_french' />} >
        </Route>
        <Route path="/table_monthly_rapport_french" element={username == "" ? <Navigate to='/home_french' /> : language2 === "french" ? <TableMonthlyRapportFrench setTableType={setTableType} titleFrench={titleFrench} rapportType={rapportType} message2={message2} username={username} moisInfo={moisInfo} detailEnvoieTotal={detailEnvoieTotal} detailEnvoieTotalTableau={detailEnvoieTotalTableau}  dailyRapport={dailyRapport} dataDetailEnvoieTotal={dataDetailEnvoieTotal} dateInfo={dateInfo} setIsadmin={setIsadmin} isAdmin={isAdmin} dataAbonne={dataAbonne}  isStaff={isStaff} language2={language2} modalShowPasswordChange={modalShowPasswordChange} setModalShowPasswordChange={setModalShowPasswordChange} modalShowContact={modalShowContact} setModalShowContact={setModalShowContact} modalShow={modalShow} modalShow4={modalShow4} setModalShow={setModalShow} setModalShow4={setModalShow4} setLanguage={setLanguage} setLanguage2={setLanguage2} uniqueNumber={uniqueNumber} setUniqueNumber={setUniqueNumber} setUsername={setUsername}  setIsStaff={setIsStaff} setIsLogged={setIsLogged} isLogged={isLogged}  language={language}/> : language2 === "lingala" ? <Navigate to='/table_monthly_rapport_lingala' /> : <Navigate to='/table_monthly_rapport_english' />} >
        </Route>
        <Route path="/table_monthly_rapport_lingala" element={username == "" ? <Navigate to='/home_lingala' /> : language2 === "lingala" ? <TableMonthlyRapportLingala setTableType={setTableType} titleLingala={titleLingala} rapportType={rapportType} message2={message2} username={username} moisInfo={moisInfo} detailEnvoieTotal={detailEnvoieTotal} detailEnvoieTotalTableau={detailEnvoieTotalTableau}  dailyRapport={dailyRapport} dataDetailEnvoieTotal={dataDetailEnvoieTotal} dateInfo={dateInfo} setIsadmin={setIsadmin} isAdmin={isAdmin} dataAbonne={dataAbonne}  isStaff={isStaff} language2={language2} modalShowPasswordChange={modalShowPasswordChange} setModalShowPasswordChange={setModalShowPasswordChange} modalShowContact={modalShowContact} setModalShowContact={setModalShowContact} modalShow={modalShow} modalShow4={modalShow4} setModalShow={setModalShow} setModalShow4={setModalShow4} setLanguage={setLanguage} setLanguage2={setLanguage2} uniqueNumber={uniqueNumber} setUniqueNumber={setUniqueNumber} setUsername={setUsername}  setIsStaff={setIsStaff} setIsLogged={setIsLogged} isLogged={isLogged}  language={language}/> : language2 === "english" ? <Navigate to='/table_monthly_rapport_english' /> : <Navigate to='/table_monthly_rapport_french' />} >
        </Route>

        <Route path="/table_yearly_rapport_english" element={username == "" ? <Navigate to='/' /> : language2 === "english" ? <TableYearlyRapportEnglish setTableType={setTableType} titleEnglish={titleEnglish} username={username}  rapportType={rapportType} message2={message2} yearInfo={yearInfo} moisInfo={moisInfo} detailEnvoieTotal={detailEnvoieTotal} detailEnvoieTotalTableau={detailEnvoieTotalTableau}  dailyRapport={dailyRapport} dataDetailEnvoieTotal={dataDetailEnvoieTotal} dateInfo={dateInfo} setIsadmin={setIsadmin} isAdmin={isAdmin} dataAbonne={dataAbonne}  isStaff={isStaff} language2={language2} modalShowPasswordChange={modalShowPasswordChange} setModalShowPasswordChange={setModalShowPasswordChange} modalShowContact={modalShowContact} setModalShowContact={setModalShowContact} modalShow={modalShow} modalShow4={modalShow4} setModalShow={setModalShow} setModalShow4={setModalShow4} setLanguage={setLanguage} setLanguage2={setLanguage2} uniqueNumber={uniqueNumber} setUniqueNumber={setUniqueNumber} setUsername={setUsername}  setIsStaff={setIsStaff} setIsLogged={setIsLogged} isLogged={isLogged}  language={language}/> : language2 === "lingala" ? <Navigate to='/table_yearly_rapport_lingala' /> : <Navigate to='/table_yearly_rapport_french' />} >
        </Route>
        <Route path="/table_yearly_rapport_french" element={username == "" ? <Navigate to='/home_french' /> : language2 === "french" ? <TableYearlyRapportFrench setTableType={setTableType} titleFrench={titleFrench} rapportType={rapportType} message2={message2} username={username} yearInfo={yearInfo} moisInfo={moisInfo} detailEnvoieTotal={detailEnvoieTotal} detailEnvoieTotalTableau={detailEnvoieTotalTableau}  dailyRapport={dailyRapport} dataDetailEnvoieTotal={dataDetailEnvoieTotal} dateInfo={dateInfo} setIsadmin={setIsadmin} isAdmin={isAdmin} dataAbonne={dataAbonne}  isStaff={isStaff} language2={language2} modalShowPasswordChange={modalShowPasswordChange} setModalShowPasswordChange={setModalShowPasswordChange} modalShowContact={modalShowContact} setModalShowContact={setModalShowContact} modalShow={modalShow} modalShow4={modalShow4} setModalShow={setModalShow} setModalShow4={setModalShow4} setLanguage={setLanguage} setLanguage2={setLanguage2} uniqueNumber={uniqueNumber} setUniqueNumber={setUniqueNumber} setUsername={setUsername}  setIsStaff={setIsStaff} setIsLogged={setIsLogged} isLogged={isLogged}  language={language}/> : language2 === "lingala" ? <Navigate to='/table_yearly_rapport_lingala' /> : <Navigate to='/table_yearly_rapport_english' />} >
        </Route>
        <Route path="/table_yearly_rapport_lingala" element={username == "" ? <Navigate to='/home_lingala' /> : language2 === "lingala" ? <TableYearlyRapportLingala setTableType={setTableType} titleLingala={titleLingala} rapportType={rapportType} message2={message2} username={username} yearInfo={yearInfo} moisInfo={moisInfo} detailEnvoieTotal={detailEnvoieTotal} detailEnvoieTotalTableau={detailEnvoieTotalTableau}  dailyRapport={dailyRapport} dataDetailEnvoieTotal={dataDetailEnvoieTotal} dateInfo={dateInfo} setIsadmin={setIsadmin} isAdmin={isAdmin} dataAbonne={dataAbonne}  isStaff={isStaff} language2={language2} modalShowPasswordChange={modalShowPasswordChange} setModalShowPasswordChange={setModalShowPasswordChange} modalShowContact={modalShowContact} setModalShowContact={setModalShowContact} modalShow={modalShow} modalShow4={modalShow4} setModalShow={setModalShow} setModalShow4={setModalShow4} setLanguage={setLanguage} setLanguage2={setLanguage2} uniqueNumber={uniqueNumber} setUniqueNumber={setUniqueNumber} setUsername={setUsername}  setIsStaff={setIsStaff} setIsLogged={setIsLogged} isLogged={isLogged}  language={language}/> : language2 === "english" ? <Navigate to='/table_yearly_rapport_english' /> : <Navigate to='/table_yearly_rapport_french' />} >
        </Route>
