...
<Row className='justify-content-center mb-3 pt-3' >
    ...
    <Row className='justify-content-center pb-3' >
        ...
        <p className='text-light'>Code Nayo Ya Abonnement : <b className='bg-warning text-dark'>{props.envoie3.infoEnvoie.code_abonne} </b> (Batela Yango Pona kosalela na prochain envoie)</p>
