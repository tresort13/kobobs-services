...
function ContactBoxEnglish(props)
{
 // const [modalShow, setModalShow] = React.useState(props.modalShow);
  ...
  const [modalShowContact4, setModalShowContact4] = React.useState(false);
   ...
   <>
   {isDesktop && <div>
    <MyVerticallyCenteredModal show={props.modalShowContact} onHide={() => props.setModalShowContact(false)} setModalShowContact={props.setModalShowContact} setModalShowContact2={setModalShowContact2} setModalShowContact3={setModalShowContact3} setModalShowContact4={setModalShowContact4}  />
  ...
  function MyVerticallyCenteredModal4(props) {
    return (
      ...
      >
        ...
        <Modal.Body>
          <p className='text-danger'><b>sorry something went wrong, try again or contact the customer's services right away on 00447417588363 !! </b>   
          </p>
        </Modal.Body>
        <Modal.Footer>
          <Button variant='danger' onClick={props.onHide}>close</Button>
