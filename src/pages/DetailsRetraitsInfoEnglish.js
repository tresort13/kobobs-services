...
<Row className='mt-3 px-5'>
        <Col xs={12} className="text-start text-light">
            {props.tableType === "dailyRapport" ? <p><Link to='/table_daily_rapport_english' style={{textDecoration:"none",fontSize:20}}><b className='couleur2'>&#8592; <u>Back</u></b></Link></p> : props.tableType === "monthlyRapport" ? <p><Link to='/table_monthly_rapport_english' style={{textDecoration:"none",fontSize:20}}><b className='couleur2'>&#8592; <u>Back</u></b></Link></p> : props.tableType === "yearlyRapport" ? <p><Link to='/table_yearly_rapport_english' style={{textDecoration:"none",fontSize:20}}><b className='couleur2'>&#8592; <u>Back</u></b></Link></p> : props.tableType === "dailyRapportRecette" ? <p><Link to='/daily_rapport_recette_english' style={{textDecoration:"none",fontSize:20}}><b className='couleur2'>&#8592; <u>Back</u></b></Link></p> : props.tableType === "monthlyRapportRecette" ? <p><Link to='/monthly_rapport_recette_english' style={{textDecoration:"none",fontSize:20}}><b className='couleur2'>&#8592; <u>Back</u></b></Link></p> : props.tableType === "yearlyRapportRecette" ? <p><Link to='/yearly_rapport_recette_english' style={{textDecoration:"none",fontSize:20}}><b className='couleur2'>&#8592; <u>Back</u></b></Link></p> : <p><Link to='/details_historic_info_english' style={{textDecoration:"none",fontSize:20}}><b className='couleur2'>&#8592; <u>Back</u></b></Link></p>}
        </Col>
    </Row>
...
<Row className='justify-content-center mb-3 pt-3' >
    ...
    <Col xs={12}>
     {props.tableType==="historic" ? props.messageEnglish === "Deletion historic" ? <div><p className='text-dark'>operation deleted by : <b className='text-dark'>{value.deletion_executed_by_owner}</b> </p>
...
<Row className='justify-content-center mb-3 pt-3' >
    ...
    <Col xs={12}>
     {props.tableType==="historic" ? props.messageEnglish === "Deletion historic" ? <div><p className='text-dark'>operation deleted by : <b className='text-dark'>{value.deletion_executed_by_owner}</b> </p>
     <p className='text-dark'>Date and time  of deletion: <b className='text-dark'> {value.date_heure_operation_deletion}</b></p><br></br>
      <Button onClick={recoverOperation}  className='mx-2' variant='success'>Recover operation</Button>
      <Button  onClick={()=>setModalShow6(true)}className='mx-2' variant='danger'>delete permanently </Button></div>  :
    <p></p> :<p></p>}        
    </Col>
