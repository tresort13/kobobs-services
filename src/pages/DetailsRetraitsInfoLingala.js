...
{isDesktop && props.detailEnvoieTotal.length > 0 ? props.detailEnvoieTotal.map((value)=>
    ...
    <Col xs={12} className="text-start text-light">
                {props.tableType === "dailyRapport" ? <p><Link to='/table_daily_rapport_lingala' style={{textDecoration:"none",fontSize:20}}><b className='couleur2'>&#8592; <u>Zonga</u></b></Link></p> : props.tableType === "monthlyRapport" ? <p><Link to='/table_monthly_rapport_lingala' style={{textDecoration:"none",fontSize:20}}><b className='couleur2'>&#8592; <u>Zonga</u></b></Link></p> : props.tableType === "yearlyRapport" ? <p><Link to='/table_yearly_rapport_lingala' style={{textDecoration:"none",fontSize:20}}><b className='couleur2'>&#8592; <u>Zonga</u></b></Link></p>: props.tableType === "dailyRapportRecette" ? <p><Link to='/daily_rapport_recette_lingala' style={{textDecoration:"none",fontSize:20}}><b className='couleur2'>&#8592; <u>Zonga</u></b></Link></p> : props.tableType === "monthlyRapportRecette" ? <p><Link to='/monthly_rapport_recette_lingala' style={{textDecoration:"none",fontSize:20}}><b className='couleur2'>&#8592; <u>Zonga</u></b></Link></p> : props.tableType === "yearlyRapportRecette" ? <p><Link to='/yearly_rapport_recette_lingala' style={{textDecoration:"none",fontSize:20}}><b className='couleur2'>&#8592; <u>Zonga</u></b></Link></p> : <p><Link to='/details_historic_info_lingala' style={{textDecoration:"none",fontSize:20}}><b className='couleur2'>&#8592; <u>Zonga</u></b></Link></p>}
            </Col>
        </Row>
    ...
    <Row className='justify-content-center pb-3'>
    <Col xs={6}>
    {props.tableType === "dailyRapport" ? <p><Link to='/table_daily_rapport_lingala' style={{textDecoration:"none",fontSize:20}}><Button variant='danger'>kokanga</Button></Link></p> : props.tableType === "monthlyRapport" ? <p><Link to='/table_monthly_rapport_lingala' style={{textDecoration:"none",fontSize:20}}><Button variant='danger'>kokanga</Button></Link></p> :props.tableType === "yearlyRapport" ? <p><Link to='/table_yearly_rapport_lingala' style={{textDecoration:"none",fontSize:20}}><Button variant='danger'>kokanga</Button></Link></p>  : props.tableType === "dailyRapportRecette" ? <p><Link to='/daily_rapport_recette_lingala' style={{textDecoration:"none",fontSize:20}}><Button variant='danger'>kokanga</Button></Link></p> : props.tableType === "monthlyRapportRecette" ? <p><Link to='/monthly_rapport_recette_lingala' style={{textDecoration:"none",fontSize:20}}><Button variant='danger'>kokanga</Button></Link></p> : props.tableType === "yearlyRapportRecette" ? <p><Link to='/yearly_rapport_recette_lingala' style={{textDecoration:"none",fontSize:20}}><Button variant='danger'>kokanga</Button></Link></p> : <p><Link to='/details_historic_info_lingala' style={{textDecoration:"none",fontSize:20}}><Button variant='danger'>kokanga</Button></Link></p>}
     </Col>
    </Row>
...
{isMobileOrTablet && props.detailEnvoieTotal.length > 0 ? props.detailEnvoieTotal.map((value)=>
    ...
    <Col xs={12}>
     {props.tableType==="historic" ? props.messageLingala === "Historique yaba suppression" ? <div><p className='text-dark'>operation supprimé epayi ya : <b className='text-dark'>{value.deletion_executed_by_owner}</b> </p>
     <p className='text-dark'>Date na heure  ya suppression: <b className='text-dark'> {value.date_heure_operation_deletion}</b></p><br></br>
      <Button onClick={recoverOperation}  className='mx-2' variant='success'>Kozongisa opération</Button>
      <Button  onClick={()=>setModalShow6(true)}className='mx-2' variant='danger'>Effacer na ndenge ya libela</Button></div> :
    <p></p> : <p></p>}        
    </Col>
