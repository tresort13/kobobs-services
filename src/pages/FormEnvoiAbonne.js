...
<Col xs={6}>
        ...
        <Col xs={6}>
        <p ><i><b className='text-light'>Kombo Abonné : </b><b className='couleur2'>{props.abonne.infoAbonne.prenom_expediteur} {props.abonne.infoAbonne.nom_expediteur} {props.abonne.infoAbonne.postnom_expediteur}</b></i></p>
        </Col>
    </Row>
...
<Form>
    ...
    <Row className='justify-content-center'>
        ...
        <option>Nzela yako zwa Mbongo (Type de retrait)</option>
         <option value= "Kozua na maboko (kozua na nzela ya agence)">Kozua na maboko </option>
