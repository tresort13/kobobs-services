...
function FormEnvoiAbonneIdFrench(props)
{
  ...
  const testValidation = yup.object().shape({
    ...
    return (
        ...
        <>
        <HeaderFrench dataAbonne={props.dataAbonne} isAdmin={props.isAdmin} abonne={props.abonne} language2={props.language2} setLanguage2={props.setLanguage2} modalShowPasswordChange={props.modalShowPasswordChange} setModalShowPasswordChange={props.setModalShowPasswordChange} modalShowContact={props.modalShowContact} setModalShowContact={props.setModalShowContact} modalShow={props.modalShow} modalShow4={props.modalShow4} setModalShow={props.setModalShow} setModalShow4={props.setModalShow4} setLanguage={props.setLanguage} uniqueNumber={props.uniqueNumber} setUniqueNumber={props.setUniqueNumber} setUsername={props.setUsername} setIsadmin={props.setIsadmin} setIsStaff={props.setIsStaff} setIsLogged={props.setIsLogged} isLogged={props.isLogged} username={props.username} language={props.language}/>
...
<Row className=' justify-content-center mb-3 pt-3' >
        ...
        {props.isStaff===true ? <p className="text-light"><i><b>{message}</b></i></p> : <p className="text-light"><i><b>Entrer votre numéro de téléphone</b></i></p>}
