...
function FormFindCodeRetraitLingala(props)
{
...
<Form onSubmit={submitNumero}>
    <Row className='justify-content-center'>
        ...
        <Form.Label className='text-dark'>code abonné nayo</Form.Label>
        <Form.Control name="codeAbonne" value={retrait.infoRetrait.codeAbonne} onChange={e=>inputChanged(e)} type="text" placeholder="code abonné nayo" autoFocus   required/>
         </Form.Group>
        </Col>
        ...
        <Col xs = {4}>
        <Form.Group className="mb-3" controlId="formBasicText" >
        <Form.Label className='text-dark'>date ya transfert nayo</Form.Label>
        <Form.Control name="dateInfo" type="date" value={retrait.infoRetrait.dateInfo} onChange={e=>inputChanged(e)}  placeholder="date ya transfert nayo" autoFocus   required/>
         </Form.Group>
        </Col>
    </Row>
<hr style={{color:"darkorange"}}></hr>
    ...
    return (
      ...
      >
        ...
        <Modal.Body>
          ...
          <p className='text-danger'><b>Bolimbisi to moni code retrait te naba informations okotisi</b>   
          </p>
        </Modal.Body>
        <Modal.Footer>
  ...
  function MyVerticallyCenteredModal3(props) {
    return (
      ...
      >
        <Modal.Header closeButton>
          <Modal.Title id="contained-modal-title-vcenter">
          <p ><b className='text-dark'>Code Retrait nayo</b></p>
          </Modal.Title>
        </Modal.Header>
        <Modal.Body>
...
export default FormFindCodeRetraitLingala;