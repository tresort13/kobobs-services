...
<Row className='mt-3'>
        <Col xs={12} className="text-start text-light">
            <p><Link to='/' style={{textDecoration:"none"}}><b className='text-light'>Home &gt;&gt; </b></Link> <Link to='/form_retrait_operation_english' style={{textDecoration:"none"}}><b className='text-warning'>Make a withdrawal</b></Link></p>
        </Col>
    </Row>
