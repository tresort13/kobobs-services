...
<Row className='mt-3'>
        <Col xs={12} className="text-start text-light">
            <p><Link to='/home_french' style={{textDecoration:"none"}}><b className='text-light'>Acceuil &gt;&gt; </b></Link> <Link to='/form_retrait_operation_french' style={{textDecoration:"none"}}><b className='text-warning'>Rétirer de l'argent</b></Link></p>
        </Col>
    </Row>
