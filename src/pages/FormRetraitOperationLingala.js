...
function FormRetraitOperationLingala(props)
{
              ...
              .then(
                res => {  
                  console.log(res) 
                   ...
                   navigate('/retrait_info_operation_lingala')
                }
              )
              .catch( (error) =>
                {
...
<Row className='mt-3'>
        <Col xs={12} className="text-start text-light">
            <p><Link to='/home_lingala' style={{textDecoration:"none"}}><b className='text-light'>Zonga na acceuil &gt;&gt; </b></Link> <Link to='/form_retrait_operation_lingala' style={{textDecoration:"none"}}><b className='text-warning'>Futa Mbongo</b></Link></p>
        </Col>
    </Row>
...
function MyVerticallyCenteredModal(props) {
    return (
      ...
      >
        ...
        <Modal.Body>
          <p className='text-danger'><b>bolimbisi code ya retrait oyo eza ko existé te !!!</b>   
          </p>
        </Modal.Body>
        <Modal.Footer>
...
export default FormRetraitOperationLingala;