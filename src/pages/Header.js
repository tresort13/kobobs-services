            ...
            <Navbar.Offcanvas
              ...
              <Offcanvas.Body>
                ...
                <Nav.Link href="/home_lingala"><b><pre>Zonga na ebandeli</pre></b></Nav.Link>
                  <NavDropdown.Divider />
                  {props.isStaff === true ? <Nav.Link href="/menu_operation_envoi_lingala"><b><pre>Tinda Mbongo</pre></b></Nav.Link>: <Nav.Link href="/form_envoie_abonne"><b><pre>Tinda Mbongo</pre></b></Nav.Link>}
                  <NavDropdown.Divider />
                  ...
                  <NavDropdown.Divider />
                  <Nav.Link  href="/form_retrait_info"><b><pre>Landela status ya transfer nayo </pre></b></Nav.Link>
                  <NavDropdown.Divider />
...
{ props.isLogged === true ? <Col xs={5} className="my-auto  my-auto text-end">
        ...
        <span>
          ...
          <Button variant='outline-light' onClick={()=>handleShow2()}  className='btn btn-outline-light btn-lg'>Mbote, <strong  className='textUpper'>{props.username}</strong> <span><svg xmlns="http://www.w3.org/2000/svg" width="25" height="25" fill="currentColor" class="bi bi-person-circle" viewBox="0 0 16 16">
   ...
   {isMobileOrTablet && <Container className="pt-2" fluid >
    ...
    <Col xs={6} className="mx-auto my-auto text-start">
        ...
        <div>
        <Button variant='outline-light'  className='btn btn-outline-dark btn-lg'>Mbote, <strong className='textUpper'>{props.username}</strong> <span><svg xmlns="http://www.w3.org/2000/svg" width="25" height="25" fill="currentColor" class="bi bi-person-circle" viewBox="0 0 16 16">
         <path d="M11 6a3 3 0 1 1-6 0 3 3 0 0 1 6 0z"/>
         <path fill-rule="evenodd" d="M0 8a8 8 0 1 1 16 0A8 8 0 0 1 0 8zm8-7a7 7 0 0 0-5.468 11.37C3.242 11.226 4.805 10 8 10s4.757 1.225 5.468 2.37A7 7 0 0 0 8 1z"/>
          </svg></span></Button>
          ...
          <Button onClick={logout} style={{marginLeft:10}}  className='btn--dark-orange btn2 rounded zoom btn-lg'>Kobima</Button>
              ...
              <Offcanvas.Body>
                ...
                <Nav.Link href="/home_lingala"><b><pre>Nzonga na ebandeli</pre></b></Nav.Link>
                  ...
                  <NavDropdown.Divider />
                  <Nav.Link href="/my_profil_french"><b><pre>bolanda status ya transfert na yo</pre></b></Nav.Link>
                  <NavDropdown.Divider />
