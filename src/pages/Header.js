...
function Header(props)
{
    ...
    <Col xs={2} className="my-auto mx-auto text-center justify-content-center">
        ...
        <Col xs={4} className="my-auto mx-auto text-end justify-content-end">
         <div className="text-end couleur2 justify-content-end">
         <p className="couleur2 text-end"><Navbar className="couleur2" placement="end"><Container><Nav className="couleu2 "><NavDropdown className="couleur2" title={props.langue} id="basic-nav-dropdown"><NavDropdown.Item href="#action/3.1" className="couleur2">Lingala</NavDropdown.Item><NavDropdown.Item href="#action/3.1" className="couleur2">English</NavDropdown.Item></NavDropdown></Nav></Container></Navbar></p>
