...
function Header(props)
{
    ...
    <Col xs={2} className="my-auto mx-auto text-center justify-content-center">
        ...
        <Col xs={2} className="my-auto mx-auto text-end justify-content-center">
         ...
         <Navbar variant="primary"><Container><Nav><p className="couleur2">{props.langue}<NavDropdown className="text-warning" ><NavDropdown.Item href="#action/3.1" className="couleur2">Lingala</NavDropdown.Item><NavDropdown.Item href="#action/3.1" className="couleur2">English</NavDropdown.Item></NavDropdown></p></Nav></Container></Navbar>
