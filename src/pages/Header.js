...
function Header(props)
{
    ...
    <Row>
        ...
        <Col xs={4} className="my-auto mx-auto text-end ">
         <div>
           <pre className="text-dark display-6" style={{fontSize: 20}}><Image className="navbar-brand rounded-circle" src={require('./login.jpeg')} type="button" alt="profil" style={{width:40}} ></Image><span ><i className="text-white"> Mbote Na Yo</i> </span><span className="separateur text-secondary"></span> <span className="couleur2"><a href="" style={{textDecoration:"none"}}><i onClick={logout}>{props.langue}</i></a></span></pre>
