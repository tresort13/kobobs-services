...
function Header(props)
{
    ...
    <Col xs={2} className="my-auto mx-auto text-center justify-content-center">
        ...
        <Col xs={4} className="my-auto mx-auto text-end ">
         <div>
         <pre className="text-dark display-6 text-center" style={{fontSize: 20}}><span ><i className="couleur2"><Navbar><NavDropdown title={props.langue} id="basic-nav-dropdown"><Dropdown.Menu><Dropdown.Item href="#action/3.1">English</Dropdown.Item></Dropdown.Menu></NavDropdown></Navbar></i></span></pre>
