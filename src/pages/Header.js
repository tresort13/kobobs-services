...
<Col xs={2} className="my-auto mx-auto text-center justify-content-center">
        ...
        <Link to="" style={{textDecoration:"none"}}>
        <Button variant='outline-light'  className='btn btn-outline-light btn-lg'>Mbote, <strong className='textUpper'>{props.username}</strong> <span><svg xmlns="http://www.w3.org/2000/svg" width="25" height="25" fill="currentColor" class="bi bi-person-circle" viewBox="0 0 16 16">
         <path d="M11 6a3 3 0 1 1-6 0 3 3 0 0 1 6 0z"/>
         <path fill-rule="evenodd" d="M0 8a8 8 0 1 1 16 0A8 8 0 0 1 0 8zm8-7a7 7 0 0 0-5.468 11.37C3.242 11.226 4.805 10 8 10s4.757 1.225 5.468 2.37A7 7 0 0 0 8 1z"/>
          </svg></span></Button>
          </Link>
          <Link to="" style={{textDecoration:"none",marginLeft:10}}>
          <Button onClick={logout} style={{marginLeft:10}}  className='btn--dark-orange btn2 rounded zoom btn-lg'>Ko bima</Button>
          </Link>
        </Col> :
        <Col xs={4} className="my-auto  my-auto text-end">
        <Link to="" style={{textDecoration:"none"}}>
          <Button onClick={showLogin}  className='btn2 btn--blue rounded zoom btn-lg '>Mikonecter</Button>
          </Link>
          <Link to="" style={{textDecoration:"none",marginLeft:10}}>
          <Button onClick={()=>openRegister()}  className='btn--dark-orange btn2 rounded zoom btn-lg'>kokomisa</Button>
          </Link>
        </Col>
         }
        ...
        */}
        ...
        <Navbar key={expand}  expand={expand} className="mb-1">
          <Container className="justify-content-end">
           ...
           <div>
             <Link to="/" style={{textDecoration:"none"}}>
             <Button  className='btn2 btn--blue rounded zoom btn-lg '>Mikonecte</Button>
             </Link>
             <Link to="/" style={{textDecoration:"none",marginLeft:10}}>
             <Button  className='btn--dark-orange btn2 rounded zoom btn-lg'>Mikomisa</Button>
             </Link>
           </div>
                </Offcanvas.Title>
              </Offcanvas.Header>
