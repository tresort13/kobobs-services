...
function HeaderEnglish(props)
{
    ...
    <Row>          
        ...
        <Col xs={4} className="my-auto mx-auto text-end ">
         <div>
           <pre className="text-dark display-6" style={{fontSize: 20}}><Image className="navbar-brand rounded-circle" src={require('./login.jpeg')} type="button" alt="profil" style={{width:40}} ></Image><span ><i className="text-white"> Welcome </i> </span><span className="separateur text-secondary"></span> <a href="" style={{textDecoration:"none"}}><span className="couleur2"><i onClick={logout}>{props.langue}</i></span></a></pre>
   ...
   {isMobileOrTablet && <Container className="pt-2 bg-dark" fluid >
    ...
    <Row className="mt-2">
        ...
        <Col xs={"auto"} className=" mx-auto my-auto text-end ">
         <div>
           <pre className="text-dark display-6 text-start" style={{fontSize: 20}}><span ><i className="couleur2">Welcome</i> </span><span className="separateur couleur2"></span> <a href="" style={{textDecoration:"none"}}><span className="couleur2"><i onClick={logout}>{props.langue}</i></span></a></pre>
