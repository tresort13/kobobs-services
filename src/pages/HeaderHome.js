...
function HeaderHome(props)
{
    ...
    <Row>
        ...
        <Col xs={4} className="my-auto mx-auto text-end ">
         <div>
           <pre className="text-dark display-6" style={{fontSize: 20}}><Image className="navbar-brand rounded-circle" src={require('./login.jpeg')} type="button" alt="profil" style={{width:40}} ></Image><span ><i className="couleur2"> Boyeyi Malamu </i> </span><span className="separateur text-white"></span> <a href="" style={{textDecoration:"none"}}><span className="couleur2"><i>Welcom</i></span></a></pre>
