 ...
 const establishedUserStatus2 = ()=>
{
  if(props.isLogged)
  {
    ...
    return (
<>
<HeaderFrench modalShow={props.modalShow} modalShow4={props.modalShow4} setModalShow={props.setModalShow} setModalShow4={props.setModalShow4} setLanguage={props.setLanguage} userID={props.userID} setUserId={props.setUserId} setUsername={props.setUsername} setIsadmin={props.setIsadmin} setIsStaff={props.setIsStaff} setIsLogged={props.setIsLogged} isLogged={props.isLogged} username={props.username}/>
{isDesktop && <Container>  
