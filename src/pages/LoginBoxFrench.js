...
function MyVerticallyCenteredModal(props) {
  ...
  <a href='https://kobobsapi.herokuapp.com/api/reset_password_french/'  className='text-primary'><strong> Mot de passe oublié ?</strong></a>
