...
{isDesktop && <Container >
    ...
    <Row className='justify-content-center pb-3 pt-5 mt-5'>
        ...
        <b className='text-dark'><pre>Rapport des récettes</pre></b>
        </Button>
        </Link>
        </Col>
    </Row>
    ...
    <Row className='justify-content-center pb-3 '>
        ...
        <Button variant='warning'  style={{width:400,height:80}} className='btn-lg rounded-pill zoom'>
        <b className='text-dark'><pre>Informations sur les abonnés</pre></b>
        </Button>
        </Link>
        </Col>
    </Row>
    ...
    <Row className='justify-content-center pb-3 '>
        ...
        <Button variant='warning'  style={{width:400,height:80}} className='btn-lg rounded-pill zoom'>
        <b className='text-dark'><pre>Gestion des utilisateurs</pre></b>
        </Button>
        </a>
        </Col>
    </Row>
