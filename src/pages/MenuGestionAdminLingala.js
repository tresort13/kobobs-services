...
function MenuGestionAdminLingala(props)
{
...
{isDesktop && <Container >
    ...
    {/*<Row className='mt-3'>
        <Col xs={12} className="text-start text-light">
            <p><Link to='/menu_management_lingala' style={{textDecoration:"none"}}><b className='text-light'>Gestions yaba Operations &gt;&gt;</b></Link> <Link to='/menu_gestion_french' style={{textDecoration:"none"}}><b className='text-warning'>Mosolo/Ba Utilisateurs </b></Link></p>
        </Col>
</Row>*/}
    ...
    <Row className='justify-content-center pb-3 pt-5 mt-5'>
        ...
        <b className='text-light'><pre>Rapport ya mosolo</pre></b>
        </Button>
        </Link>
        </Col>
    </Row>
    ...
    <Row className='justify-content-center pb-3 '>
        ...
        <Button variant='btn--blue'  style={{width:400,height:80,border:"2px solid white"}} className='btn-lg btn--blue rounded-pill zoom py-4'>
        <b className='text-light'><pre>Informations yaba abonnés</pre></b>
        </Button>
        </Link>
        </Col>
    </Row>
    ...
    <Row className='justify-content-center pb-3 '>
        ...
        <Button variant='btn--blue'  style={{width:400,height:80,border:"2px solid white"}} className='btn-lg btn--blue rounded-pill zoom py-4'>
        <b className='text-light'><pre>gestion yaba utilisateurs</pre></b>
        </Button>
        </a>
        </Col>
    </Row>
...
export default MenuGestionAdminLingala;