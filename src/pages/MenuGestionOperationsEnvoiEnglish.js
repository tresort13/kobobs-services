...
{isDesktop && <Container className="text-light text-bold" >
    <Row className='mt-3'>
        <Col xs={12} className="text-start text-light">
            <p><Link to='/' style={{textDecoration:"none"}}><b className='text-light'>Home &gt;&gt;</b></Link> <Link to='/menu_operation_envoi_english' style={{textDecoration:"none"}}><b className='text-warning'>Sending Money </b></Link></p>
        </Col>
    </Row>
