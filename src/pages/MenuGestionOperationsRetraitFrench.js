...
{isDesktop && <Container >
    ...
    <Row className='mt-3'>
        <Col xs={12} className="text-start text-light">
            <p><Link to='/menu_management_french' style={{textDecoration:"none"}}><b className='text-light'>Gestions des opérations &gt;&gt;</b></Link> <Link to='/menu_operation_retrait_french' style={{textDecoration:"none"}}><b className='text-warning'>Opérations des Rétrait </b></Link></p>
        </Col>
    </Row>
    <Row className='justify-content-center pb-3 pt-5 mt-5'>
        ...
        <b className='text-light'><pre>Effectuer un retrait</pre></b>
        </Button>
        </Link>
        </Col>
    </Row>
    ...
    <Row className='justify-content-center pb-3'>
        ...
        <Button variant='btn--blue'  style={{width:400,height:80}} className='btn-lg btn--blue rounded zoom py-4'>
        <b className='text-light'><pre>Rapport des opérations Retraits</pre></b>
        </Button>
        </Link>
        </Col>
    </Row>
...
export default MenuGestionOperationsRetraitFrench;