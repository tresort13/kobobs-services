...
function MenuInfoAbonnesEnglish(props)
{
 ...
 {/*   <Row className='justify-content-center pb-3' >
    ...
    */}
    ...
    <Row className='justify-content-center text-center mx-3 px-3 py-3' >
        ...
        <Form.Label htmlFor="basic-url" className='text-start'><strong>Find a subscriber</strong></Form.Label>
...
function MyVerticallyCenteredModal(props) {
  return (
    ...
    >
      ...
      <Modal.Body>
        <p className='couleur2'><b>no any subscriber with this number</b>   
        </p>
      </Modal.Body>
      <Modal.Footer>
...
export default MenuInfoAbonnesEnglish;