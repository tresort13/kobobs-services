...
function MenuInfoAbonnesFrench(props)
{
...
{isDesktop && <Container className='bg-light justify-content-center text-center  mb-5' style={{border:"2px solid black"}} >
 ...
 {/*   <Row className='justify-content-center pb-3' >
    ...
    */}
    ...
    <Row className='justify-content-center text-center mx-3 px-3 py-3' >
        ...
        <Form.Label htmlFor="basic-url" className='text-start'><strong>Réchercher un abonné</strong></Form.Label>
        <InputGroup className="mb-3" controlId="formBasicText" >  
        <Form.Control name="numero_expediteur" value={values.numero_expediteur} onChange={handleChange} onBlur={handleBlur} type="text" placeholder='Numéro de Téléphone'  />
...
<Row className='justify-content-start' >
        <Col xs={12}>
        <p className='couleur2'><i><b>Information sur l'abonné</b></i></p>
        </Col>
    </Row>
    ...
    <Row className='justify-content-center pb-3' >
        <Col xs={6}>
        <Link to="/menu_gestion_french" style={{color:'white',textDecorationLine:'none'}}>
...
function MyVerticallyCenteredModal(props) {
  return (
    ...
    >
      ...
      <Modal.Body>
        <p className='couleur2'><b>aucun abonné avec ce numéro</b>   
        </p>
      </Modal.Body>
      <Modal.Footer>
...
export default MenuInfoAbonnesFrench;