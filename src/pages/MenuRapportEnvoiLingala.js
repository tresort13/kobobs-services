...
{isDesktop && <Container >
    <Row className='mt-3'>
        <Col xs={12} className="text-start text-light">
            <p><Link to='/menu_management_lingala' style={{textDecoration:"none"}}><b className='text-light'>Gestion yaba Opérations &gt;&gt; </b></Link> <Link to='/menu_rapport_envoi_lingala' style={{textDecoration:"none"}}><b className='text-warning'>Rapport yaba envois</b></Link></p>
        </Col>
    </Row>
...
export default MenuRapportEnvoiLingala;