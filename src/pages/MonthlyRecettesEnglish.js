...
function MonthlyRecettesEnglish(props)
{
 ...
 writeFile(workbook, ""+title+".xlsx", { compression: true });
    ...
    return (
        <>
            ...
            <p><Link to='/select_mois_rapport_recette_lingala' style={{textDecoration:"none",fontSize:20}}><b className='couleur2'>&#8592; <u>Back</u>  </b></Link> </p>
           </Col>
             </Row>
...
export default MonthlyRecettesEnglish;