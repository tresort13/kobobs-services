...
<Row className='justify-content-center  pt-3' >
    ...
    <Form noValidate onSubmit={handleSubmit}>
       ...
       <Col xs={4}>
        <i><b className='text-dark text-center'>Sélectionnez le type d'opération à vérifier : </b></i>
        </Col>
        <Col xs={4} >
     <div ><Form.Select aria-label="Default select example" name='operationType'   value={values.operationType} onChange={handleChange}>
        <option value="">Sélectionnez l'opération</option>
         ...
         <option value="withdrawal">Rétrait</option>
         </Form.Select>
...
<Row className='justify-content-start ' >
  <Col xs={2}>
       ...
       { props.isStaff === true ? <p ><i><b>Votre historique  à la date du <span className='couleur2'>{localDate} :</span> </b></i></p> : 
       <p ><i><b>Votre historique  à la date du <span className='couleur2'>{localDate} :</span> </b></i></p>}
        </Col>
    </Row>
  { props.isStaff === true ?
      ...
      <Col xs={2}>
       ...
       { operationType === "sending" ?  <Col xs={4}>
        ...
        {nombre_envoie_valide > 0 ? <p className='text-dark py-2 text-start'><strong>Nombre de validations effectuées :</strong> <b className='couleur2'>  {nombre_envoie_valide}</b>  </p> : <span></span>}
         ...
         <Col xs={4}>
         {nombre_retrait_paye > 0 ? <p className='text-dark py-2 text-center'><strong> nombre de retraits effectués :</strong> <b className='couleur2'>  {nombre_retrait_paye}</b>  </p> :<span></span> }
...
function MyVerticallyCenteredModal(props) {
  return (
    ...
    >
      ...
      <Modal.Body>
        <p className='couleur2'><b>vous n'avez effectué aucune action à cette date !</b>   
        </p>
      </Modal.Body>
      <Modal.Footer>
