...
function SelectDateFormRetraitFrench(props)
{
  ...
  const testValidation = yup.object().shape({
    ...
    const [message,setMessage] = useState("Selectionner la date pour le rapport de rétrait journalier")
        ...
        fetch('https://kobobsapi.herokuapp.com/api/getDailyRapportInfoRetrait/', {
          ...
          .then(
            res => {   
               ...
               navigate('/daily_rapport_retrait_french')
            }
          )
          .catch( (error) =>
            {
    ...
    return (
      ...
      >
        ...
        <Modal.Body>
          ...
          <p className='text-danger'><b>Désolé pas de rapport de rétrait sur la date sélectionnée !!!</b>   
          </p>
        </Modal.Body>
        <Modal.Footer>
...
export default SelectDateFormRetraitFrench;