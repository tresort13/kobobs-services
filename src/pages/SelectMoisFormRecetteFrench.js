...
function SelectMoisFormRecetteFrench(props)
{
  ...
  const testValidation = yup.object().shape({
    ...
    const [message,setMessage] = useState("Selectionner le mois pour le rapport les récettes mensuel ")
...
export default SelectMoisFormRecetteFrench;