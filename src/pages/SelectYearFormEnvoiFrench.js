...
function SelectYearFormEnvoiFrench(props)
{
  ...
  const testValidation = yup.object().shape({
    ...
    const [message,setMessage] = useState("Entrer l'année pour le rapport d'envoi annuel")
...
export default SelectYearFormEnvoiFrench;