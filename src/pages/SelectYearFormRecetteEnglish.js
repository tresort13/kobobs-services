...
function SelectYearFormRecetteEnglish(props)
{
  ...
  const testValidation = yup.object().shape({
    ...
    const [message,setMessage] = useState("Enter the year for yearly incomes rapport")
        ...
        fetch('https://kobobsapi.herokuapp.com/api/getYearlyRapportRecetteInfo/', {
          ...
          .then(
            res => {   
               ...
               navigate('/yearly_rapport_recette_english')
            }
          )
          .catch( (error) =>
            {
...
export default SelectYearFormRecetteEnglish;