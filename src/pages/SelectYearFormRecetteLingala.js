...
function SelectYearFormRecetteLingala(props)
{
  ...
  const testValidation = yup.object().shape({
    ...
    const [message,setMessage] = useState("Kotisa mbula pona rapport yaba recettes na mbula")
        ...
        fetch('https://kobobsapi.herokuapp.com/api/getYearlyRapportRecetteInfo/', {
          ...
          .then(
            res => {   
               ...
               navigate('/yearly_rapport_recette_lingala')
            }
          )
          .catch( (error) =>
            {
...
export default SelectYearFormRecetteLingala;