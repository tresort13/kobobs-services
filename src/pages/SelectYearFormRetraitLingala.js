...
function SelectYearFormRetraitLingala(props)
{
  ...
  const testValidation = yup.object().shape({
    dateInfo : yup.string().required('esengeli ko kotisa mbula'),
  });
    ...
    const [message,setMessage] = useState("Kotisa mbula pona rapport yaba retraits na mbula")
        ...
        fetch('https://kobobsapi.herokuapp.com/api/getYearlyRapportInfoRetrait/', {
          ...
          .then(
            res => {   
               ...
               navigate('/yearly_rapport_retrait_lingala')
            }
          )
          .catch( (error) =>
            {
...
export default SelectYearFormRetraitLingala;