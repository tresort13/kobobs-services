...
function TableAbonnesEnglish(props)
{
...
const operationDetailArray = []
    ...
    return (
        <>
            ...
            <p><Link to='/menu_info_abonne_english' style={{textDecoration:"none",fontSize:20}}><b className='couleur2'>&#8592; <u>Back</u>  </b></Link> </p>
           </Col>
             </Row>
...
<Row className='justify-content-center '>
        ...
        <div>
        <h4 ><u><b><i className='couleur2'>Subscriber's Informations</i></b></u></h4>
        </div>
        <div>
        ...
        {props.abonneInfo2.map((value)=>
        {
          return  <tr  style={{border:"2px solid white"}} >
             ...
             <td onClick={()=>{
               ...
               navigate('/details_abonnes_info_english')
...
export default TableAbonnesEnglish;