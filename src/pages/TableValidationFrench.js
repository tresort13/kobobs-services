...
<Row className='justify-content-center '>
        ...
        <div>
        <h6 ><u><b><i className='couleur2'>Opérations d'envoi non validées</i></b></u></h6>
        </div>
        <div>
      ...
      {envoie4.map((value)=>
        {
          return  <tr  style={{border:"2px solid white"}} >
             ...
             <td onClick={()=>{
               ...
               navigate('/form_abonne_non_valide_french')
             }} ><i className="text-primary btn" ><b><u>Voir pour validation</u></b></i></td>
            </tr> 
        }) 
        }
...
export default TableValidationFrench;