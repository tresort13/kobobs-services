...
function TableYearlyRapportLingala(props)
{
...
const export_excel = ()=>{
  ...
  if(rapportLocation === "Rapport Angola et RD Congo")
  {
    dailyRecettes = props.detailEnvoieTotalTableau.map((value)=>{
     ...
     title = "Angola na RD Congo "+props.yearInfo+""
    console.log(title)
    dailyRecettes.push({
      date : "TOTAL",
      withdrawal_code : "",
 ...
 /* fix headers */
 utils.sheet_add_aoa(worksheet, [["Mbula","Code ya rétrait", "Kombo Motindi","Numéro ya Motindi","Kombo Mozui","Mboka Ya Mozui","Montant ya Mozui($)"]], { origin: "A1" });
...
<Row className='justify-content-center '>
        ...
        <div>
        <h4 ><u><b><i className='couleur2'>{props.titleLingala} {props.yearInfo}</i></b></u></h4>
        </div>
        <div>
...
export default TableYearlyRapportLingala;