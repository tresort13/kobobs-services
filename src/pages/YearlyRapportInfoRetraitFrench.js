...
function YearlyRapportInfoRetraitFrench(props)
{

    const [message,setMessage] = useState("Rapport Annuel des Retrait")
...
<Row className='mt-3 px-5'>
        <Col xs={12} className="text-start text-light">
            <p><Link to='/select_year_form_retrait_french' style={{textDecoration:"none",fontSize:20}}><b className='couleur2'>&#8592; <u>Retourner</u>  </b></Link> </p>
        </Col>
    </Row>
...
export default YearlyRapportInfoRetraitFrench;