...
function YearlyRapportInfoRetraitLingala(props)
{

    const [message,setMessage] = useState("Rapport mbula na mbula yaba Rétraits")
    ...
    const isDesktop = useMediaQuery({
      ...
      const nombre_retrait_paye = props.yearlyRapport.filter((value)=>
      {
      ...
      const nombre_retrait_valide = props.yearlyRapport.filter((value)=>
      {
      ...
      const nombre_retrait_nonvalide = props.yearlyRapport.filter((value)=>
      {
      ...
      const detailPaye =()=>
      {
       ...
       props.setRapportType("yearlyRapportRetrait")
...
<Row className='mt-3 px-5'>
        <Col xs={12} className="text-start text-light">
            <p><Link to='/select_year_form_retrait_lingala' style={{textDecoration:"none",fontSize:20}}><b className='couleur2'>&#8592; <u>Zonga</u>  </b></Link> </p>
        </Col>
    </Row>
...
<Row className='justify-content-center mb-3 pt-3' >
    ...
    <Row className='justify-content-center pb-3' >
        <Col xs={12}>
        <p className='text-dark'><b>Type ya Rapport:</b> <b className='couleur2'>mbula na mbula</b> </p>
        <p className='text-dark'><b>mbula ya:</b> <b className='couleur2'>{props.yearInfo}</b>  </p>
...
function MyVerticallyCenteredModal(props) {
  return (
    ...
    >
      ...
      <Modal.Body>
        <p className='couleur2'><b>operation eza te na mbula oponi</b>   
        </p>
      </Modal.Body>
      <Modal.Footer>
...
export default YearlyRapportInfoRetraitLingala;