...
function YearlyRecettesFrench(props)
{
...
const yearlyRecettes = props.yearlyRapport.map((value)=>{
 ...
 const title = "Récettes Annuelle "+props.yearInfo+""
 console.log(title)
 ...
 /* fix headers */
 utils.sheet_add_aoa(worksheet, [["Année","Code de rétrait", "Noms Expéditeur","Numéro Expéditeur","Noms Bénéficiaire","Pays Bénéficiaire","Montant Bénéficiaire($)","Frais Envoi(£)","Frais TVA(£)","Montant Total(£)"]], { origin: "A1" });
 ...
 writeFile(workbook, ""+title+".xlsx", { compression: true });
    ...
    return (
        <>
            ...
            <p><Link to='/select_year_rapport_recette' style={{textDecoration:"none",fontSize:20}}><b className='couleur2'>&#8592; <u>Retourner</u>  </b></Link> </p>
           </Col>
             </Row>
...
<Row className='justify-content-center '>
        ...
        <div>
        <h4 ><u><b><i className='couleur2'>Table des Recettes Annuelles</i></b></u></h4>
        </div>
        <div>
...
export default YearlyRecettesFrench;