...
function YearlyRecettesLingala(props)
{
...
const yearlyRecettes = props.yearlyRapport.map((value)=>{
 ...
 const title = "Récettes ya mbula "+props.yearInfo+""
 console.log(title)
 ...
 /* fix headers */
 utils.sheet_add_aoa(worksheet, [["mbula","Code ya rétrait", "Kombo Motindi","Numéro ya Motindi","Kombo Mozui","Mboka Ya Mozui","Montant ya Mozui($)","Frais ya Envoi(£)","Frais ya TVA(£)","Mbongo Total(£)"]], { origin: "A1" });
 ...
 writeFile(workbook, ""+title+".xlsx", { compression: true });
    ...
    return (
        <>
            ...
            <p><Link to='/select_year_rapport_recette_lingala' style={{textDecoration:"none",fontSize:20}}><b className='couleur2'>&#8592; <u>Zonga</u>  </b></Link> </p>
           </Col>
             </Row>
...
<Row className='justify-content-center '>
        ...
        <div>
        <h4 ><u><b><i className='couleur2'>Tableau ya ba recettes ya mbula na mbula</i></b></u></h4>
        </div>
        <div>
...
export default YearlyRecettesLingala;